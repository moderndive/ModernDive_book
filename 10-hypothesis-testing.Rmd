...
### Are men and women evaluated for jobs differently?

### An assumed alternate universe
...
Simply put: Choose between two possible truths while accounting for sampling variation.
...
An "alternate universe" distribution
...
Permutation test resampling without replacement

### Revisit verb framework
...
A yes/no-type decision: statistical significance via alpha
...
### Analogy: US criminal justice {#trial}
...
## Case study: Number of countries in Africa A/B test
...
## Old case study: Comparing two means
...
p-hacking, hard to understand, ASA statement, why the letter p?


### Theory: Neyman-Pearson lemma


### Formula: t-test {#theory-hypo}
