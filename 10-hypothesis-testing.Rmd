...
What we just demonstrated in this activity is the statistical procedure known as *hypothesis testing*, specifically via a *permutation test*. Such procedures allow us to test the validity of hypotheses using sampled data. 
