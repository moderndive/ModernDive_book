...
However, each of these 48 resumes were identical in all respects except one: the name of the applicant at the top of the resume. 24 of the supervisors were randomly given resumes with stereo-typically "male" names while 24 of the supervisors were randomly given resumes with stereo-typically "female" names. Since only (binary) gender varied from resume to resume, researchers could isolate the effect of this variable in promotion rates. 
...
First, a **hypothesis** \index{hypothesis} is a statement about the value of an unknown population parameter. In our resume activity, our population parameter is the difference in population proportions $p_{m} - p_{f}$. Hypothesis tests can involve any of the population parameters in Table \@ref(tab:table-ch8) of the 6 inference scenarios we'll cover in this book and more.
...
```{r zcurve, echo=FALSE, out.width="60%", fig.cap="Standard normal z curve."}
...
```{r t-distributions, echo=FALSE, fig.cap="Examples of t-distributions and the z curve.", purl=FALSE, out.width="60%"}
knitr::include_graphics("images/t-distributions.png")
# ggplot(data.frame(x = c(-4, 4)), aes(x)) + 
#   stat_function(fun = dnorm, linetype = "dashed") +
#   stat_function(fun = dt, args = list(df = 1), color = "pink") +
#   stat_function(fun = dt, args = list(df = 3), color = "magenta") +
#   stat_function(fun = dt, args = list(df = 10), color = "brown") +  
#   labs(x = "", y = "") + 
#  scale_fill_manual(values = c("black", "pink", "magenta", "brown")) +
#  guides(color = c("z", "t1", "t3", "t10")) +
  # theme(axis.title.y = element_blank(),
  #       axis.text.y = element_blank(),
  #       axis.ticks.y = element_blank())
```
