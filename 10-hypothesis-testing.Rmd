...
Much like with our case study on whether yawning is contagious from Section \@ref(#case-study-two-prop-ci), we are interested in inferring about the difference in population proportions $p_{m} - p_{f}$. Recall our summary table of sampling scenarios from Table \@ref(table:summarytable-ch8-c).
...
```{r infer-ht, echo=FALSE, fig.cap="Hypothesis testing via infer", purl=FALSE, out.width="90%"}
...
#### 2. `hypothesize` the null and alternative {-}
...
### Comparison with confidence intervals {#only-one-test}
