...
ModernDive is built using [Quarto](https://quarto.org/), an open-source scientific and technical publishing system. For more information on how to use Quarto see [quarto.org](https://quarto.org/). If you'd like to build the book on your own, please make sure to first install Quarto from [quarto.org/docs/get-started](https://quarto.org/docs/get-started/).

* The Quarto source code for the current version of the book is in the `master` branch of this repo. 
* The source code for all [previously released versions](https://moderndive.com/index.html#about-book) of ModernDive is accessible on the [Releases](https://github.com/moderndive/moderndive_book/releases) page. A summary of all changes between versions can be found in [NEWS.md](https://github.com/moderndive/moderndive_book/blob/master/NEWS.md).
...
* The Quarto source code for the future version of the book is in the `v2` branch of this repo.
