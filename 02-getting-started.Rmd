...
```{r R-vs-RStudio-1, echo=FALSE, fig.align='center', fig.cap="Analogy of difference between R and RStudio.", out.width='80%', purl=FALSE}
...
```{r R-vs-RStudio-2, echo=FALSE, fig.align='center', fig.cap="Icons of R versus RStudio on your computer.", out.width='80%', purl=FALSE}
...
```{r RStudio-interface, echo=FALSE, fig.align='center', fig.cap="RStudio interface to R.", out.height=if(knitr:::is_latex_output()) '2.5in', purl=FALSE}
...
```{r R-vs-R-packages, echo=FALSE, fig.align='center', fig.cap="Analogy of R versus R packages.", out.width='80%', purl=FALSE}
...
```{r echo=FALSE, fig.align='center', fig.cap="Installing packages in R the easy way.", out.height=if(knitr:::is_latex_output()) '2.5in', purl=FALSE}
