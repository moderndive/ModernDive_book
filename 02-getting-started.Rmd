...
* **Learning to code is like learning a foreign language**:  Just as it can be very frustrating when first starting to learn a new language, learning to code can be initially very frustrating as well. This is entirely normal. The only solution is practice. Just as you can't go months without speaking a new foreign language, you can't go long periods of time without practice in R and catch on.  Don't worry however, we'll give you plenty of opportunities to practice!
