...
|---|---|---|---|---|---|
| Week 1 | Ch 1 | Course intro + R/RStudio setup | Install R + RStudio + tidyverse; tour the book; first scripts | Problem Set 0: setup verification | [slides](slides/01-slides.html) · [notes](facilitator-notes/01_notes.qmd) |
| Week 2 | Ch 2 | Grammar of graphics, scatterplots, linegraphs | 5NG #1-2 worked examples + group critique of student-built plots | Problem Set 1 released (Ch 1-2 mix) | [slides](slides/02-slides.html) · [notes](facilitator-notes/02_notes.qmd) |
...
| Week 4 | Ch 3 | Data wrangling I: filter / summarize / group_by | Live coding from flights; debugging-walkthrough on a broken pipeline | PS1 due; PS2 released | [slides](slides/03-slides.html) · [notes](facilitator-notes/03_notes.qmd) |
...
| Week 6 | Ch 4 | Importing data + tidy data principles | Real-world messy-CSV import lab; pivot_longer / pivot_wider drill | PS2 due | [slides](slides/04-slides.html) · [notes](facilitator-notes/04_notes.qmd) |
| Week 7 | Ch — | Midterm review + midterm exam | Day 1: jeopardy-style retrieval over Ch 1-4; Day 2: in-class exam | Midterm exam | — |
| Week 8 | Ch 5 | Basic regression: one numerical predictor | Walk through `get_regression_table()` + `get_regression_points()` on `evals` | PS3 released | [slides](slides/05-slides.html) · [notes](facilitator-notes/05_notes.qmd) |
| Week 9 | Ch 6 | Multiple regression: two numerical predictors | 3D regression visualization; interpret coefficients in context | — | [slides](slides/06-slides.html) · [notes](facilitator-notes/06_notes.qmd) |
| Week 10 | Ch 6 | Multiple regression: interactions + categorical predictors | Interaction-vs-parallel-slopes group activity | PS3 due | [slides](slides/06-slides.html) · [notes](facilitator-notes/06_notes.qmd) |
| Week 11 | Ch 7 | Sampling distributions + the bootstrap intuition | Tactile sampling activity (red/white balls); virtual sampling with `rep_sample_n()` | Final project proposal due | [slides](slides/07-slides.html) · [notes](facilitator-notes/07_notes.qmd) |
| Week 12 | Ch 8 | Confidence intervals | Bootstrap CI lab; CI-interpretation common-mistake gallery | PS4 released | [slides](slides/08-slides.html) · [notes](facilitator-notes/08_notes.qmd) |
| Week 13 | Ch 9 | Hypothesis testing | Permutation-test simulation; build a null world step by step | — | [slides](slides/09-slides.html) · [notes](facilitator-notes/09_notes.qmd) |
| Week 14 | Ch 10 | Inference for regression | Bringing it all together: bootstrap CIs for regression slopes | PS4 due | [slides](slides/10-slides.html) · [notes](facilitator-notes/10_notes.qmd) |
| Week 15 | Ch 11 | Tell your story with data + final-project workshop | Peer review of final-project drafts; presentations day 2 | Final project due (end of week) | [slides](slides/11-slides.html) · [notes](facilitator-notes/11_notes.qmd) |
