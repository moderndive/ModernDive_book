...
```{r getting-started-R-vs-RStudio-alt, echo=FALSE, fig.cap="Icons of R versus RStudio on your computer.", out.width="90%", purl=FALSE}
...
```{r easy-way-install, echo=FALSE, fig.cap="Installing packages in R the easy way.", out.width="49%", purl=FALSE}
...
```{r ismay-book, echo=FALSE, fig.cap="(ref:ismay-book)", purl=FALSE, out.width=if(knitr::is_latex_output()) "82%"}
...
```{r moderndive-flowchart, echo=FALSE, fig.cap="(ref:flowchart2)", out.width="70%", purl=FALSE}
