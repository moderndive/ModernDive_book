...
```{r numxcatxplot1, echo=FALSE, fig.cap="Colored scatterplot of life expectancy and fertility rate.", fig.height=ifelse(knitr::knitr::is_latex_output(), 3.2, 4), purl=FALSE, message=FALSE}
...
```{r numxcatx-parallel, echo=FALSE, fig.cap="Parallel slopes model of fertility rate with life expectancy and income.", fig.height=ifelse(knitr::knitr::is_latex_output(), 2.7, 4), purl=FALSE}
...
```{r fitted-values, echo=FALSE, fig.cap="Fitted values for two new countries.", fig.height=ifelse(knitr::knitr::is_latex_output(), 4.7, 5), purl=FALSE, message=FALSE}
newpoints <- 
  get_regression_points(model_int, newdata = slice(UN_data_ch6, c(41, 102)))
...
```{r 2numxplot1, echo=FALSE, fig.cap="Relationship between credit card debt and credit limit/income.", fig.height=ifelse(knitr::knitr::is_latex_output(), 3.2, 4), purl=FALSE, message=FALSE}
