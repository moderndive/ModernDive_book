...
::: {.callout-tip collapse="true" title="Show answer"}
**(b)** This is the principle of parsimony: pick the simpler model when both visibly fit the data about equally well. If the interaction-term coefficients are small and overlaying the two models' fitted lines on the scatterplot shows nearly identical curves, the interaction term is mostly fitting noise — the parallel-slopes model captures the same relationship with less risk.
:::
