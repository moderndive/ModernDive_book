...
\begin{verbatim}
## [1] "By Chester on Friday, January 06, 2017 15:06:12 EST"
\end{verbatim}
...
two independent samples case we have for comparing action movies to
romance movies, the formula is
...
distribution of \(\delta = \bar{x}_1 - \bar{x}_2\) using randomization
above. Recall what this distribution looks like:
...
\NormalTok{rand_distn %>%}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{t_stat)) +}
\StringTok{  }\KeywordTok{geom_histogram}\NormalTok{(}\DataTypeTok{color =} \StringTok{"white"}\NormalTok{, }\DataTypeTok{bins =} \DecValTok{20}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\caption[Population ratings histogram]{Population ratings histogram}\label{fig:unnamed-chunk-117}
\end{figure}
...
\caption[Sample ratings histogram]{Sample ratings histogram}\label{fig:unnamed-chunk-119}
\end{figure}
...
\caption[Bootstrapped means histogram]{Bootstrapped means histogram}\label{fig:unnamed-chunk-125}
\end{figure}
...
\caption[Simulated shuffled sample means histogram]{Simulated shuffled sample means histogram}\label{fig:unnamed-chunk-129}
\end{figure}
...
\caption[Number of flights departing NYC in 2013 by airline - Descending numbers]{Number of flights departing NYC in 2013 by airline - Descending numbers}\label{fig:unnamed-chunk-137}
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{ismaykim_files/figure-latex/unnamed-chunk-139-1} \end{center}
