...
This is version 0.4.0.9000 of ModernDive published on August 19, 2018.
...
\centering
\fontsize{10}{12}\selectfont
\begin{tabular}[t]{r>{\raggedright\arraybackslash}p{3.5in}l}
\toprule
...
\begin{tabular}{r>{\raggedright\arraybackslash}p{0.7in}>{\raggedright\arraybackslash}p{1in}>{\raggedright\arraybackslash}p{0.7in}>{\raggedright\arraybackslash}p{1in}}
\toprule
