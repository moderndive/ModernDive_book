...
\begin{verbatim}
## [1] "By Chester on Friday, January 06, 2017 23:47:49 EST"
\end{verbatim}
...
\caption[Type I and Type II errors]{Type I and Type II errors}\label{fig:unnamed-chunk-84}
\end{figure}
...
\caption[Genre vs rating for our sample]{Genre vs rating for our sample}\label{fig:unnamed-chunk-97}
\end{figure}
...
\caption[Genre vs rating for our sample as faceted histogram]{Genre vs rating for our sample as faceted histogram}\label{fig:unnamed-chunk-98}
\end{figure}
...
\caption[Simulated differences in means histogram]{Simulated differences in means histogram}\label{fig:unnamed-chunk-104}
\end{figure}
...
\caption[Shaded histogram to show p-value]{Shaded histogram to show p-value}\label{fig:unnamed-chunk-105}
\end{figure}
...
\caption[Histogram with vertical lines corresponding to observed statistic]{Histogram with vertical lines corresponding to observed statistic}\label{fig:unnamed-chunk-106}
\end{figure}
...
\caption[Simulated differences in means histogram]{Simulated differences in means histogram}\label{fig:unnamed-chunk-108}
\end{figure}
...
\caption[Simulated T statistics histogram]{Simulated T statistics histogram}\label{fig:unnamed-chunk-112}
\end{figure}
...
\begin{center}\includegraphics[width=\textwidth]{ismaykim_files/figure-latex/unnamed-chunk-113-1} \end{center}
...
\begin{center}\includegraphics[width=\textwidth]{ismaykim_files/figure-latex/unnamed-chunk-115-1} \end{center}
...
\caption[Population ratings histogram]{Population ratings histogram}\label{fig:unnamed-chunk-120}
\end{figure}
...
\caption[Sample ratings histogram]{Sample ratings histogram}\label{fig:unnamed-chunk-122}
\end{figure}
...
{\centering \includegraphics[width=\textwidth]{ismaykim_files/figure-latex/unnamed-chunk-127-1} 

}

\caption[Bootstrapped means histogram]{Bootstrapped means histogram}\label{fig:unnamed-chunk-127}
\end{figure}
...
\caption[Simulated shuffled sample means histogram]{Simulated shuffled sample means histogram}\label{fig:unnamed-chunk-131}
\end{figure}
...
\begin{center}\includegraphics[width=\textwidth]{ismaykim_files/figure-latex/unnamed-chunk-145-1} \end{center}
...
assumption is valid in Subsection \ref{resid}.
...
\begin{center}\includegraphics[width=\textwidth]{ismaykim_files/figure-latex/unnamed-chunk-147-1} \end{center}
...
{\centering \includegraphics[width=\textwidth]{ismaykim_files/figure-latex/unnamed-chunk-148-1} 

}

\caption[Shaded histogram to show p-value]{Shaded histogram to show p-value}\label{fig:unnamed-chunk-148}
\end{figure}
...
read this article by Walt Hickey entitled
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{download.file}\NormalTok{(}\StringTok{"http://ismayc.github.io/teaching/sample_problems/ageAtMar.csv"}\NormalTok{, }
  \DataTypeTok{destfile =} \StringTok{"data/ageAtMar.csv"}\NormalTok{,}
  \DataTypeTok{method =} \StringTok{"curl"}\NormalTok{)}
...
\begin{center}\includegraphics[width=\textwidth]{ismaykim_files/figure-latex/unnamed-chunk-153-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{download.file}\NormalTok{(}\StringTok{"http://ismayc.github.io/teaching/sample_problems/offshore.csv"}\NormalTok{, }\DataTypeTok{destfile =} \StringTok{"data/offshore.csv"}\NormalTok{, }\DataTypeTok{method =} \StringTok{"curl"}\NormalTok{)}
...
\begin{center}\includegraphics[width=\textwidth]{ismaykim_files/figure-latex/unnamed-chunk-167-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{download.file}\NormalTok{(}\StringTok{"http://ismayc.github.io/teaching/sample_problems/zinc_tidy.csv"}\NormalTok{,}
              \DataTypeTok{destfile =} \StringTok{"data/zinc_tidy.csv"}\NormalTok{,}
              \DataTypeTok{method =} \StringTok{"curl"}\NormalTok{)}
...
\begin{center}\includegraphics[width=\textwidth]{ismaykim_files/figure-latex/unnamed-chunk-173-1} \end{center}
...
\begin{center}\includegraphics[width=\textwidth]{ismaykim_files/figure-latex/unnamed-chunk-175-1} \end{center}
...
{\centering \includegraphics[width=\textwidth]{ismaykim_files/figure-latex/unnamed-chunk-181-1} 

}

\caption[Number of flights departing NYC in 2013 by airline - Descending numbers]{Number of flights departing NYC in 2013 by airline - Descending numbers}\label{fig:unnamed-chunk-181}
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{ismaykim_files/figure-latex/unnamed-chunk-183-1} \end{center}
