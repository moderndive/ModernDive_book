...
=======
\date{2017-03-13}
>>>>>>> c53a11623b64c99bfef3f3a4ffc93d43e6b47397
...
<<<<<<< HEAD
Book was last updated by Chester on Tuesday, March 14, 2017 08:13:46
PDT.
=======
Book was last updated by cismay on Monday, March 13, 2017 15:22:30 PDT.
>>>>>>> c53a11623b64c99bfef3f3a4ffc93d43e6b47397
...
observed difference in means was 0.8294. It falls far outside the range
of simulated differences. We can add a vertical line to represent both
it and its negative (since this is a two-tailed test) instead:
...
\begin{center}\includegraphics[width=\textwidth]{ismaykim_files/figure-latex/unnamed-chunk-103-1} \end{center}
...
\caption[Simulated T statistics histogram]{Simulated T statistics histogram}\label{fig:unnamed-chunk-108}
\end{figure}
...
\begin{center}\includegraphics[width=\textwidth]{ismaykim_files/figure-latex/unnamed-chunk-111-1} \end{center}
...
\caption[Population ratings histogram]{Population ratings histogram}\label{fig:unnamed-chunk-116}
\end{figure}
...
\caption[Sample ratings histogram]{Sample ratings histogram}\label{fig:unnamed-chunk-118}
\end{figure}
...
\caption[Bootstrapped means histogram]{Bootstrapped means histogram}\label{fig:unnamed-chunk-123}
\end{figure}
...
\caption[Simulated shuffled sample means histogram]{Simulated shuffled sample means histogram}\label{fig:unnamed-chunk-127}
\end{figure}
...
{\centering \includegraphics[width=\textwidth]{ismaykim_files/figure-latex/unnamed-chunk-144-1} 

}

\caption[Shaded histogram to show p-value]{Shaded histogram to show p-value}\label{fig:unnamed-chunk-144}
\end{figure}
...
\begin{center}\includegraphics[width=\textwidth]{ismaykim_files/figure-latex/unnamed-chunk-172-1} \end{center}
...
{\centering \includegraphics[width=\textwidth]{ismaykim_files/figure-latex/unnamed-chunk-179-1} 

}

\caption[Number of flights departing NYC in 2013 by airline - Descending numbers]{Number of flights departing NYC in 2013 by airline - Descending numbers}\label{fig:unnamed-chunk-179}
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{ismaykim_files/figure-latex/unnamed-chunk-181-1} \end{center}
