...
for(i in 1:nrow(pennies_sample)){
  # Set year
  locations <- locations %>%
    mutate(year = pennies_sample$year[i])
...
system("\"/System/Library/Automator/Combine PDF Pages.action/Contents/Resources/join.py\" -o images/sampling/pennies/pennies_paper_slips.pdf images/sampling/pennies/*.pdf")
