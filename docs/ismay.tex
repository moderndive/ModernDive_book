...
\begin{verbatim}
## [1] "By Chester on Friday, September 09, 2016 18:30:03 PDT"
\end{verbatim}
...
been donwloaded and installed. You can ensure it is installed by running
the code below:
...
not, then goes to the specified repo of
