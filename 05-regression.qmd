...
In @sec-multiple-regression on multiple regression, we extend these ideas and work with models with two explanatory variables.  In @sec-model4, we work with one numerical and one categorical explanatory variable and study the model with and without interactions. In @sec-model3, we work with two numerical explanatory variables.
