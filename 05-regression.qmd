...
In a statistical modeling context, this is also known as a *dummy variable*. \index{dummy variable} In our case, we consider the first such indicator variable $\mathbb{1}_{\text{Asia}}(x)$. This indicator function returns 1 if a country is in the Asia, 0 otherwise:
