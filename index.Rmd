...
# Copy all needed csv files to docs/
dir.create("docs/files")
file.copy("data/dem_score.csv", "docs/files/dem_score.csv", overwrite = TRUE)
file.copy("data/dem_score.xlsx", "docs/files/dem_score.xlsx", overwrite = TRUE)
file.copy("data/le_mess.csv", "docs/files/le_mess.csv", overwrite = TRUE)
