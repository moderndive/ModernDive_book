...
latest_release_date <- "February 09, 2017"
...
**Important Note**: This is the development version (v`r version`) of ModernDive and is still in the process of being edited. For the current version of ModernDive, please go to [ModernDive.com](http://moderndive.com/). 

<!--
**Important Note**: This is a previous version (v`r version`) of ModernDive and may be out of date. For the current version of ModernDive, please go to [ModernDive.com](http://moderndive.com/). 
-->
...
This is version `r version` of ModernDive from `r date`. For previous versions of ModernDive, see Section \@ref(about-book).
...
* **Development version** The working copy of the next version which is currenltly being edited:
...
* **Previous versions** Older versions that may be out of date:
    ...
    + [Version 0.1.2](https://github.com/ismayc/moderndiver-book/releases/tag/v0.1.2) released on January 22, 2017 ([source code](https://github.com/ismayc/moderndiver-book/releases/tag/v0.1.2))
