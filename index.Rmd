...
# Version number
version <- "0.1.3.9000"
# Version date. Change this to be a hard coded date and in the YAML header above
# when updating a version of the text. Ex:
# data <- "August 01, 2017"
...
**Please Note**: This is the development version of ModernDive and has not been officially released yet. For the latest officially released version of ModernDive, please go to [ModernDive.com](http://moderndive.com/). 
...
This is ModernDive version `r version`, which was released on `r date`. For previous versions of ModernDive, click [here](#version).
...
What do we mean by data stories? We mean any analysis involving data that engages the reader in answering questions with careful visuals and thoughtful discussion, such as ["How strong is the relationship between per capita income and crime in Chicago neighborhoods?"](http://rpubs.com/ry_lisa_elana/chicago) and ["How many f**ks does Quentin Tarantino give (as measured by the amount of swearing in his films)?"](https://ismayc.github.io/soc301_s2017/group_projects/group4.html) Further guidelines on data stories can be found in [this article](https://www.thinkwithgoogle.com/marketing-resources/data-measurement/tell-meaningful-stories-with-data/) from Think With Google.  For other examples of such data stories, look at the final projects for two courses that have used ModernDive previously:
...
This book will help you develop your "data science toolbox", including tools such as data visualization, data formatting, data wrangling, and data modeling via regression. With these tools, you'll be able to perform the entirety of the "data/science pipeline" (see Chapter \@ref(pipeline) for more details) while building data communication skills. 
...
We understand that there may be challenging moments as you learn to program.  Both of us continue to struggle and find ourselves often using web searches to find answers and reach out to colleagues for help.  In the long run though, we solve problems faster and more elegantly via programming.  We wrote this book as our way to help you get started and you should know that there is a huge community of R users that are always happy to help everyone along as well.  This community exists in particular on the internet on various forums and sites such as [stackoverflow.com](https://stackoverflow.com/).
...
At this point, if you are interested in intructor perspectives on this book, ways to contribute and collaborate, or the technical details of this book's contruction and publishing, then continue with the rest of the chapter below.  Otherwise, let's get started with R and RStudio in Chapter \@ref(getting-started)!
...
* The source code that created this book is available on [GitHub](https://github.com/ismayc/moderndiver-book/releases/tag/v`r version`).
...
* Current version: You are currently reading ModernDive version `r version`, which was released on `r date`.
...
If you find typos or other errors or have suggestions on how to better word something in the book, please create a pull request on GitHub too!  We also welcome issue creation on GitHub.  Let's all work together to make this book as great as possible for as many students and instructors as possible.
...
The authors would like to thank Nina Sonneborn, Kristin Bott, and the participants of our [USCOTS 2017 workshop](https://www.causeweb.org/cause/uscots/uscots17/workshop/3) for their feedback and suggestions.  A special thanks goes to Prof. Yana Weinstein, cognitive psychological scientist and co-Founder of [The Learning Scientists](http://www.learningscientists.org/yana-weinstein/) for her contributions and perspective.
