...
if(knitr::is_html_output()){
  include_image(path = "images/crc_press.jpg", 
...
<center>
`r include_image("images/Rlogo.png", html_opts = "height=100px", latex_opts = "height=10%")`        \hfill &emsp; &emsp; &emsp; `r include_image("images/RStudio-Logo-Blue-Gradient.png", html_opts = "height=100px", latex_opts = "height=10%")`
</center>
...
If you're asking yourself this question, then you've come to the right place! Start with the "Introduction for students" section below. 

* *Are you an instructor hoping to use this book in your courses? Then read the "Introduction for instructors" section below for more information on how to teach with this book.*
* *Are you looking to connect with and contribute to ModernDive? Then read the "Connect and contribute" section below for information on how.*
* *Are you curious about the publishing of this book? Then read the "About this book" section below for more information on the open-source technology, in particular R Markdown and the bookdown package.*
...
1. Data science with `tidyverse`. You'll assemblee your data science toolbox using `tidyverse` packages. In particular you'll
...
1. Statistical inference with `infer`. Once again using your newly acquired data science tools, you'll unpack statistical inference using the `infer` package. In particular you'll:
    ...
    + Ch.\@ref(confidence-intervals): Contruct confidence intervals.
...
* Please let us know if you find any errors, typos, or areas from improvement on our [GitHub issues](https://github.com/moderndive/moderndive_book/issues) \index{GitHub issues} page.
* If you are familiar with GitHub and would like to contribute more, please see the "About this book" section below.

For example, we thank

* [Dr. Andrew Heiss](https://twitter.com/andrewheiss) for contributing Subsection \@ref(tips-code) on "Errors, warnings, and messages."
* [Starry Zhou](https://github.com/Starryz) for her many edits to the book.

The authors would like to also thank [Nina Sonneborn](https://github.com/nsonneborn), [Kristin Bott](https://twitter.com/rhobott?lang=en), [Dr. Jenny Smetzer](https://www.smith.edu/academics/faculty/jennifer-smetzer), and the participants of our [USCOTS 2017 workshop](https://www.causeweb.org/cause/uscots/uscots17/workshop/3) for their feedback and suggestions.  A special thanks goes to Dr. Yana Weinstein, cognitive psychological scientist and co-founder of [The Learning Scientists](http://www.learningscientists.org/yana-weinstein/), for her extensive contributions.
