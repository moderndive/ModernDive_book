...
* The source code for this book is available for download/forking on [GitHub](https://github.com/ismayc/moderndiver-book).  If you find typos or other errors or have suggestions on how to better word something in the book, please create a pull request too!
