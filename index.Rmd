...
* (Under construction) We the proceed to cover topics related to **statistical inference**, the bread and butter of statistics. To this end, we'll leverage a new package for tidyverse-friendly inference called [`infer`](https://infer.netlify.com/index.html). In particular
    + Chapter \@ref(sampling) on sampling theory.
    + Chapter \@ref(ci) on confidence intervals.
    + Chapter \@ref(hypo) on hypothesis testing.
