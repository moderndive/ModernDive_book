...
* Packages: Packages in R are supplemental functions and data that aren't automatically loaded at start-up. 
    + Installing them by download
    + Updating them
    + loading them via `library()`
    + Use `LC.Rmd` Lec01 R Scripts and Lec02 R Packages
