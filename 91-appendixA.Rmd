...
The normal distribution is one of the most commonly studied distributions in statistics. For a discussion on the properties of a normal distribution, please read Subsection \@ref(normal-distribution).
