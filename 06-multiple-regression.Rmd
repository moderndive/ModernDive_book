...
```
```{r numxcatx-comparison-2, fig.height=3.8, echo=FALSE, warning=FALSE, fig.cap="Comparison of interaction and parallel slopes models for Massachusetts schools."}
