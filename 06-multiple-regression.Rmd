...
```{r numxcatx-parallel, echo=FALSE, fig.cap="Parallel slopes model of fertility rate with life expectancy and income.", fig.height=ifelse(knitr::is_latex_output(), 2.4, 7), purl=FALSE}
...
package\index{\index{R packages!ISLR2} for the first time in this book using 
its `Credit` data set. This data set contains 
