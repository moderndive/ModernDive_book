...
```{r recall-parallel-vs-interaction, fig.height=5, echo=FALSE, fig.cap="Previously seen comparison of interaction and parallel slopes models."}
if(knitr::is_html_output()){
  interaction_plot + parallel_slopes_plot
} else {
  grey_interaction_plot <- interaction_plot +
...
```
```{r numxcatx-comparison-2, fig.height=4, echo=FALSE, warning=FALSE, fig.cap="Comparison of interaction and parallel slopes models for Massachusetts schools."}
