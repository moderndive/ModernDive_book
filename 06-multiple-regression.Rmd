...
**`r paste0("(LC", chap, ".", (lc <- lc + 1), ")")`** What does a model with one categorical regressor and one numerical regressor, but no interactions, can be interpreted?
...
<!-- Multicollinearity does no longer appear in the chapter.
