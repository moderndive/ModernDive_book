...
```{r load-tidyverse-1, echo=FALSE, message=FALSE, purl=TRUE}
library(tidyverse)
library(moderndive)
library(ISLR2)
```

```{r load-kableExtra, message=FALSE, echo=FALSE, purl=FALSE}
...
```{r load-ISLR2-1, eval=FALSE, echo=FALSE, purl=FALSE}
...
```{r model-4, echo=FALSE, purl=FALSE}
# Fit regression model:
