...
newpoints <- evals_ch6 |>
  slice(c(1, 5)) |>
  (\(.) get_regression_points(model = score_model_interaction, newdata = .))()
...
Congratulations! We've completed the "Statistical/Data Modeling with `moderndive`" portion of this book. We're ready to proceed to Part III of this book: "Statistical Inference with `infer`." Statistical inference is the science of inferring about some unknown quantity using sampling. 
