...
What can you say about the relationship between a credit card holder's balance and their credit rating and age? Recall that if you've lost some information from the dataset in it's original form, you can reload a fresh copy using `data("Credit")`. 
...
there is on average an associated decrease of $b_{age}$ = -0.009 in teaching score.
