...
Now in Figure \@ref(fig:2numxplot4) let's re-display two versions of the scatterplot of debt and income from Figure \@ref(fig:2numxplot1-repeat) above, but with a slight twist:
