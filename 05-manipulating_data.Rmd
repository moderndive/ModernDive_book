...
**`r paste0("(LC", chap, ".", (lc <- lc + 1), ")")`** What are some ways to select all three of `dest`, `air_time`, and `distance` variables from `flights`?  Give the code showing how to do this in at least three different ways.
