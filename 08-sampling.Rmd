...
1. The histogram in Figure \@ref(fig:sampling-distribution-1) is called the **sampling distribution** of $\widehat{p}$ based on samples of size $n=50$. It describes how values of the sample proportion red will vary from sample-to-sample due to the aforementioned **sampling variability**.
