...
1. Standard normal
1. Rules of thumb: 68% $\pm$ 1 SD, 95% $\pm$ 2 SD, 99% 3 SD. Need visualization
...
ggplot(data = data.frame(x = c(-3.5, 3.5)), aes(x)) +
  ...
  geom_vline(xintercept = -1.96, color = "green", size = 1) +
  geom_vline(xintercept = 1.64, color = "red", size = 1) +
  geom_vline(xintercept = -1.64, color = "red", size = 1) +
  geom_vline(xintercept = 2.33, color = "yellow", size = 1) +
  geom_vline(xintercept = -2.33, color = "yellow", size = 1) 
```
