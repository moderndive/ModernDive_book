...
In other words, the Harvard University Institute of Politics poll can be thought of as *an instance* of using the shovel to sample balls from the bowl. Furthemore, if another polling company conducted a similar poll of young Americans at roughly the same time, they would likely get a different estimate than 41%. This is due to *sampling variation*.
