...
:-------------------------:|:-------------------------:
![](images/ss/669837769.png){ height=1.7in }  |  ![](images/ss/111211685.png){ height=1.7in }
-->
```{r tactile-vs-virtual-simulation, echo=FALSE, fig.align='center', fig.cap="Two kinds of simulations: tactile and virtual.", out.width='100%', purl=FALSE}
knitr::include_graphics("images/tactile_vs_virtual_simulation.png")
```
...
Shuyi Chiou, Casey Dunn, and Pathikrit Bhattacharyya created the following 3m38s video at https://youtu.be/jvoxEYmQHNM explaining this crucial statistical theorem using the average weight of wild bunny rabbits and the average wing span of dragons as examples.
