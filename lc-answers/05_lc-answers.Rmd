...
EDA = raw data + summaries + plot. The scatterplot with the regression line and the correlation quantify direction/strength. This data shows that richer countries have higher obesity rates and lower fertility, so we see a **negative** association (points sloping down; negative correlation).
