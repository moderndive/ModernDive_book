...
```{r lc-03-3, eval=FALSE, purl=FALSE}
# Original in book
not_BTV_SEA <- flights |>
...
```{r lc-03-4, echo=FALSE, purl=FALSE}
...
```{r lc-03-6, purl=FALSE}
by_monthly_origin <- flights |>
  group_by(month, origin) |>
  summarize(count = n())
```

```{r lc-03-7, eval=FALSE, purl=FALSE}
by_monthly_origin
```

```{r lc-03-8, echo=FALSE, purl=FALSE}
...
```{r lc-03-10, eval=FALSE, purl=FALSE}
count_flights_by_airport
```

```{r lc-03-11, echo=FALSE, purl=FALSE}
