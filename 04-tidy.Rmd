...
```{r read-excel, echo=FALSE, fig.cap="Importing an Excel file to R.", purl=FALSE, out.width=if(!knitr::is_latex_output()) "100%"}
...
```{r part2, echo=FALSE, fig.cap="(ref:flowchart-partii)", out.height="25%", purl=FALSE}
