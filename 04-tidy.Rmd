...
```{r drinks-smaller, fig.cap="Comparing alcohol consumption in 4 countries.", fig.height=ifelse(knitr::is_latex_output(), 3.9, 7), echo=FALSE, purl=FALSE}
...
```{r drinks-smaller-tidy-barplot, echo=FALSE, fig.cap="(ref:drinks-col)", fig.height=ifelse(knitr::is_latex_output(), 2.5, 7), purl=FALSE}
if (is_html_output()) {
  drinks_smaller_tidy_plot
} else {
  drinks_smaller_tidy_plot + scale_fill_grey()
...
```{r guat-dem-tidy, fig.cap="Democracy scores in Guatemala 1952-1992.", fig.height=ifelse(knitr::is_latex_output(), 3, 7)}
...
```{r part2, echo=FALSE, fig.cap="(ref:flowchart-partii)", fig.height=ifelse(knitr::is_latex_output(), 5.5, 7), purl=FALSE}
