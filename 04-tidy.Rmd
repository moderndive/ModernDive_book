...
```{r drinks-smaller-tidy-barplot, echo=FALSE, fig.cap='(ref:drinks-col)', fig.height=3.8}
if(knitr::is_html_output()){
  drinks_smaller_tidy_plot
} else {
  drinks_smaller_tidy_plot + scale_fill_grey()
...
```{r part2, echo=FALSE, fig.cap="ModernDive flowchart - On to Part II!", fig.align='center', fig.height=5.5, purl=FALSE}
