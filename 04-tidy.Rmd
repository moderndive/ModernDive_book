...
```{r preview-data, echo=FALSE, purl=FALSE}
drinks |>
  head(5)
```
...
```{r code-2, eval=FALSE, purl=FALSE}
airline_safety
```
...
```{r load-ggplot2, eval=FALSE, purl=FALSE}
library(ggplot2)
library(dplyr)
library(readr)
library(tidyr)
...
```{r load-tidyverse, eval=FALSE, purl=FALSE}
library(tidyverse)
```

would be the same as running:

```{r load-ggplot2-1, eval=FALSE, purl=FALSE}
library(ggplot2)
library(dplyr)
library(readr)
library(tidyr)
