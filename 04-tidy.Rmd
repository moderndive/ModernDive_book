...
Let's now ask ourselves a question: "Using the `drinks_smaller` data frame, how would we create the side-by-side (i.e. dodged) barplot in Figure \@ref(fig:drinks-smaller)?" Recall we saw barplots displaying two categorical variables in Section \@ref(two-categ-barplot).
