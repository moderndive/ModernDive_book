...
```{r inference-for-regression-1, message=FALSE}
library(tidyverse)
library(moderndive)
library(infer)
library(gridExtra)
...
```{r inference-for-regression-2, message=FALSE, echo=FALSE, purl=FALSE}
...
```{r inference-for-regression-4, eval=FALSE}
UN_data_ch10
```

```{r inference-for-regression-5, echo=FALSE}
n_UN_data_ch10 <- nrow(UN_data_ch10)
```

```{r inference-for-regression-6, echo=FALSE}
...
```{r inference-for-regression-7, eval=FALSE}
simple_model <- lm(fert_rate ~ life_exp, data = UN_data_ch10)
coef(simple_model)
```

```{r inference-for-regression-8, echo=FALSE, purl=FALSE}
...
```{r inference-for-regression-9, eval=FALSE}
UN_data_ch10 |>
  rowid_to_column() |>
...
```{r inference-for-regression-10, echo=FALSE}
...
```{r inference-for-regression-11, eval=FALSE}
UN_data_ch10 |>
  filter(country == "France")
```

```{r inference-for-regression-12, echo=FALSE}
france_data <- UN_data_ch10 |>
  filter(country == "France")
france_data
```

```{r inference-for-regression-13, echo=FALSE}
...
```{r inference-for-regression-14, eval=FALSE}
simple_model |>
...
```{r inference-for-regression-16, eval=FALSE}
old_faithful_2024 |>
  select(duration, waiting) |> 
  tidy_summary()
```

```{r inference-for-regression-17, echo=FALSE}
old_faithful_2024 |>
  select(duration, waiting) |> 
  tidy_summary() |> 
  kbl() |> 
...
```{r inference-for-regression-18, echo=FALSE}
...
```{r inference-for-regression-19, eval=FALSE}
# Fit regression model:
...
```{r inference-for-regression-20, eval=FALSE}
...
```{r inference-for-regression-21, echo=-1}
set.seed(6)
...
```{r inference-for-regression-22, eval=FALSE}
spotify_for_anova |> 
  slice_sample(n = 5)
```
...
```{r inference-for-regression-24, eval=FALSE}
...
```{r inference-for-regression-27, echo=FALSE}
# This code is used for dynamic non-static in-line text output purposes
...
```{r inference-for-regression-28, eval=FALSE}
...
```{r inference-for-regression-30, eval=FALSE}
...
```{r inference-for-regression-31, eval=FALSE}
...
```{r inference-for-regression-32, eval = FALSE}
fitted_and_residuals |>
...
```{r inference-for-regression-33, echo=FALSE, results="asis"}
if(!is_latex_output()) 
...
```{r inference-for-regression-34, echo=FALSE}
n_reps <- 1000
```
...
```{r inference-for-regression-35, eval=FALSE}
...
```{r inference-for-regression-36, echo=FALSE, purl=FALSE}
...
```{r inference-for-regression-40, eval=FALSE}
...
```{r inference-for-regression-41, echo=FALSE, purl=FALSE}
...
```{r inference-for-regression-46, eval=FALSE}
coffee_data |>
  tidy_summary()
```
...
```{r inference-for-regression-47, echo=FALSE}
# This code is used for dynamic non-static in-line text output purposes
...
```{r inference-for-regression-48, echo=FALSE}
# This code is used for dynamic non-static in-line text output purposes
...
```{r inference-for-regression-49, eval=FALSE}
# Fit regression model:
mod_mult <- lm(
...
```{r inference-for-regression-50, eval=FALSE}
coffee_data |>
...
```{r inference-for-regression-51, echo=FALSE, purl=FALSE}
...
```{r inference-for-regression-52, eval=FALSE}
...
```{r inference-for-regression-53, eval=FALSE}
# Fit regression model:
mod_mult_1 <- lm(
...
```{r inference-for-regression-54, eval=FALSE}
# Fit regression model:
mod_mult_2 <- lm(
...
```{r inference-for-regression-55, echo=FALSE}
# This code is used for dynamic non-static in-line text output purposes
...
```{r inference-for-regression-56, eval=FALSE}
...
```{r inference-for-regression-57, eval=FALSE}
...
```{r inference-for-regression-58, eval=FALSE}
...
```{r inference-for-regression-59, eval=FALSE}
...
```{r inference-for-regression-61, grid-arrange-plot-check, fig.cap="Residuals vs. fitted values plot and QQ-plot for the multiple regression model.", fig.height=ifelse(knitr::is_latex_output(), 2, 4)}
g1 <- fit_and_res_mult |>
...
```{r inference-for-regression-63, eval=FALSE}
mod_mult_table
```
...
```{r inference-for-regression-64, eval=FALSE}
coffee_data |>
  specify(
...
```{r inference-for-regression-65, echo=FALSE}
...
```{r inference-for-regression-66, eval=FALSE}
...
```{r inference-for-regression-67, echo=FALSE}
...
```{r inference-for-regression-68, eval=FALSE}
visualize(boot_distribution_mlr)
```

```{r inference-for-regression-69, echo=FALSE}
...
```{r inference-for-regression-72, eval=FALSE}
visualize(null_distribution_mlr) +
  shade_p_value(obs_stat = observed_fit, direction = "two-sided")
```

```{r inference-for-regression-73, echo=FALSE}
...
```{r inference-for-regression-75, echo=FALSE, results="asis", purl=FALSE}
if (is_latex_output()) {
...
```{r inference-for-regression-76, echo=FALSE, purl=FALSE, results="asis"}
