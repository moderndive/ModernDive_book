...
```{r not-normal-residuals, echo=FALSE, fig.cap="Non-normal residuals.", message=FALSE, purl=FALSE, fig.height=ifelse(knitr::is_latex_output(), 1.4, 7)}
set.seed(3)
...
```{r residual-plot, fig.cap="Plot of residuals against the regressor.", message=FALSE, fig.height=ifelse(knitr::is_latex_output(), 1.5, 7)}
...
```{r equal-variance-residuals, echo=FALSE, fig.cap="Example of clearly non-equal variance.", purl=FALSE, fig.height=ifelse(is_latex_output(), 2, 7)}
old_faithful_2024 |>
...
```{r p-value-slope, echo=FALSE, fig.show="hold", fig.cap="Null distribution and $p$-value.", fig.height=ifelse(knitr::is_latex_output(), 3.8, 7), purl=FALSE}
visualize(null_distn_slope) +
...
```{r, fig.cap="Residuals vs. fitted values plot and QQ-plot for the multiple regression model", fig.height=ifelse(knitr::is_latex_output(), 4, 7)}
g1 <- fit_and_res_mult |>
...
```{r ci-slopes-multiple, fig.cap="95% confidence intervals for the partial slopes.", fig.height=8.5}
visualize(boot_distribution_mlr) +
...
```{r, fig.height=6, fig.cap="Shaded p-values for the partial slopes in this multiple linear regression."}
