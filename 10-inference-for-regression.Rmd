...
```{r residual-example, echo=FALSE, fig.cap="Example of observed value, fitted value, and residual.", purl=FALSE}
...
```{r non-linear, fig.cap="Example of a clearly non-linear relationship.", echo=FALSE, fig.height=3.3, purl=FALSE}
set.seed(76)
evals_ch5 %>% 
  mutate(
    x = bty_avg,
