...
```{r inference-for-regression-lm-fertility-2, echo=FALSE, purl=FALSE}
...
```{r inference-for-regression-filter-2, eval=FALSE}
UN_data_ch10 |>
  filter(country == "France")
```
...
```{r inference-for-regression-filter-3, eval=FALSE}
simple_model |>
...
```{r inference-for-regression-select-vars-2, eval=FALSE}
old_faithful_2024 |>
  select(duration, waiting) |> 
  tidy_summary()
```

```{r inference-for-regression-select-vars-3, echo=FALSE}
old_faithful_2024 |>
  select(duration, waiting) |> 
  tidy_summary() |> 
  kbl() |> 
...
```{r inference-for-regression-fit-lm-2, eval=FALSE}
...
```{r inference-for-regression-fit-lm-3, eval=FALSE}
...
```{r inference-for-regression-dynamic-text-2, echo=FALSE}
# This code is used for dynamic non-static in-line text output purposes
...
```{r inference-for-regression-fit-lm-4}
# Fit regression model:
model_1 <- lm(waiting ~ duration, data = old_faithful_2024)
...
```{r inference-for-regression-bootstrap-2, echo=FALSE, purl=FALSE}
...
```{r inference-for-regression-conf-interval-2}
...
```{r inference-for-regression-null-dist-2, echo=FALSE, purl=FALSE}
...
```{r inference-for-regression-specify-2}
# Observed slope
...
```{r inference-for-regression-dynamic-text-3, echo=FALSE}
# This code is used for dynamic non-static in-line text output purposes
...
```{r inference-for-regression-fit-lm-5, eval=FALSE}
# Fit regression model:
mod_mult <- lm(
...
```{r inference-for-regression-select-vars-4, eval=FALSE}
coffee_data |>
...
```{r inference-for-regression-select-vars-5, echo=FALSE, purl=FALSE}
...
```{r inference-for-regression-reg-table-2, eval=FALSE}
...
```{r inference-for-regression-fit-lm-6, eval=FALSE}
# Fit regression model:
mod_mult_1 <- lm(
...
```{r inference-for-regression-fit-lm-7, eval=FALSE}
# Fit regression model:
mod_mult_2 <- lm(
...
```{r inference-for-regression-dynamic-text-4, echo=FALSE}
# This code is used for dynamic non-static in-line text output purposes
...
```{r inference-for-regression-reg-table-3, eval=FALSE}
...
```{r inference-for-regression-reg-table-4, eval=FALSE}
...
```{r inference-for-regression-fit-lm-8}
# Fit regression model:
...
```{r inference-for-regression-specify-3}
...
```{r inference-for-regression-bootstrap-3, eval=FALSE}
coffee_data |>
  specify(
...
```{r inference-for-regression-bootstrap-4, echo=FALSE}
...
```{r inference-for-regression-bootstrap-5, eval=FALSE}
...
```{r inference-for-regression-viz-dist-2, echo=FALSE}
...
```{r inference-for-regression-conf-interval-3}
...
```{r inference-for-regression-null-dist-3}
set.seed(2024)
...
```{r inference-for-regression-viz-pvalue-2, echo=FALSE}
...
```{r inference-for-regression-conditional-text-2, echo=FALSE, results="asis", purl=FALSE}
if (is_latex_output()) {
