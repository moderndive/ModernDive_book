...
```{r sampling-1, echo=FALSE, results="asis", purl=FALSE}
if (is_latex_output()) {
...
```{r sampling-3, message=FALSE, echo=FALSE, purl=FALSE}
...
```{r sampling-10, echo=TRUE, fig.show='hide'}
...
```{r sampling-16, echo=TRUE, fig.show='hide'}
...
```{r sampling-18, echo=TRUE, fig.show='hide'}
ggplot(virtual_prop_red, aes(x = prop_red)) +
...
```{r sampling-19, echo=FALSE, results="asis", purl=FALSE}
if(!is_latex_output()) 
...
```{r sampling-22, echo=TRUE, results='hide'}
virtual_prop_red_50 |> 
...
```{r sampling-23, echo=FALSE, purl=FALSE}
...
```{r sampling-37, echo=TRUE, fig.show='hide'}
...
```{r sampling-45, echo=TRUE, fig.show='hide'}
...
```{r sampling-46, echo=FALSE, results='asis', purl=FALSE}
if (is_latex_output())
...
```{r sampling-47, echo=FALSE, results="asis", purl=FALSE}
if (is_latex_output()) {
