...
Furthermore, this is one the key messages of the Central Limit Theorem we saw in Subsection \@ref(sampling-conclusion-central-limit-theorem): as the sample size $n$ increases, distribution of averages gets narrower as quantified by the standard deviation of the sampling distribution of the sample mean, which in turn has a special name: the standard error of the sample mean. 
