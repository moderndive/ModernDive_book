...
1. Statistical/Data modeling with `moderndive` (revisited): Armed with your understanding of statistical inference, you'll revisit and review the models you'll construct in Ch.\@ref(regression) and Ch.\@ref(multiple-regression). In particular, you'll:
...
:-------------------------:|:-------------------------:|:-------------------------:
`r include_image(path = "images/ismay2024.jpg", html_opts = "height=220px", latex_opts = "width=46%")` | `r include_image(path = "images/kim.png", html_opts = "height=220px", latex_opts = "width=46%")` | <!--`r include_image(path = "images/valdivia.jpg", html_opts = "height=220px", latex_opts = "width=46%")` -->
