...
:-------------------------:|:-------------------------:|:-------------------------:
`r include_image(path = "images/ismay2024.jpg", html_opts = "height=220px", latex_opts = "width=33%")` | `r include_image(path = "images/kim.png", html_opts = "height=220px", latex_opts = "width=33%")` | <!--`r include_image(path = "images/valdivia.jpg", html_opts = "height=220px", latex_opts = "width=33%")` -->
