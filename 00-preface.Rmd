...
```{r pipeline-figure, echo=FALSE, fig.align='center', fig.cap="Data/science pipeline.", out.height="1.85in"}
...
Both Drs. Ismay and Kim, along with [Jennifer Chunn](https://github.com/jchunn), are co-authors of the [`fivethirtyeight`](https://fivethirtyeight-r.netlify.com/) package of code and data sets published by the data journalism website [FiveThirtyEight.com](https://fivethirtyeight.com/).
