...
* **Future edition** We are currently working on a future edition of ModernDive:
    ...
    + Source code: Available on ModernDive's GitHub repository page in the `v2` branch <https://github.com/moderndive/ModernDive_book/tree/v2>.
