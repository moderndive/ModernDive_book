...
We explain the bootstrap method when used to construct an interval estimate for
...
as if it were an estimate of the population distribution.
...
@sec-simulation-based-CI we obtain a 
...
but this is a really large number, as discussed in @sec-simulation-based-CI. Instead, only a few thousand bootstrap samples are 
used.
...
[@Hall1992] has provided the theoretical justification to use 
