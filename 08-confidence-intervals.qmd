...
```{r fig-sample-mean-100-with-normal-redraw, echo=FALSE, fig.height=ifelse(knitr::is_latex_output(), 1.9, 4), fig.cap="The distribution of the sample mean.", purl=FALSE}
...
```{r fig-normal-curves, echo=FALSE, fig.cap="Three normal distributions.", purl=FALSE, fig.height=ifelse(knitr::is_latex_output(), 1, 4)}
all_points <- tibble(
...
```{r fig-normal-curve-shaded-1a, echo=FALSE, fig.height=ifelse(knitr::is_latex_output(), .9, 4), fig.width=3, fig.cap="Normal area within one standard deviation."}
...
```{r fig-normal-curve-shaded-2a, echo=FALSE, fig.height=ifelse(knitr::is_latex_output(), 0.9, 4), fig.width=3, fig.cap="Normal area within two standard deviations."}
ggplot(data = data.frame(x = c(-4, 4)), aes(x)) +
  stat_function(fun = dnorm, args = list(mean = 0, sd = 1)) +
...
```{r fig-normal-curve-1, echo=FALSE, fig.cap="Normal density curve for the sample mean weight of almonds.", purl=FALSE, out.width="90%", warning=FALSE, fig.height=ifelse(knitr::is_latex_output(), 3, 4)}
...
```{r fig-normal-curve-2, echo=FALSE, fig.cap="Is the population mean in the interval?", purl=FALSE, out.width="90%", warning=FALSE}
...
```{r fig-t-curve-1, echo=FALSE, fig.cap="The standard normal and two t-distributions.", purl=FALSE, fig.height=ifelse(knitr::is_latex_output(), 2.5, 4)}
...
```{r fig-almond-mean-cis, fig.cap="One hundred 95% confidence intervals and whether the population mean is captured in each.", echo=FALSE, fig.height=ifelse(knitr::is_latex_output(), 5, 5), purl=FALSE}
set.seed(202)
...
```{r fig-normal-curve-shaded-3a, echo=FALSE, fig.cap="Normal curve with the shaded middle area being 0.95", fig.height=ifelse(knitr::is_latex_output(), 1.5, 4), fig.width=3}
ggplot(data = data.frame(x = c(-4, 4)), aes(x)) +
  stat_function(fun = dnorm, args = list(mean = 0, sd = 1)) +
...
```{r fig-confidence-intervals-tactile-resampling-alt, echo=FALSE, fig.cap="Step 2: Weighing one almond at random.", fig.show="hold", purl=FALSE, out.width="30%"}
...
```{r fig-confidence-intervals-tactile-resampling-v4, echo=FALSE, fig.cap="Step 3: Replacing almond.", fig.show="hold", purl=FALSE, out.width="50%"}
...
```{r fig-origandresample, echo=FALSE, fig.cap="Comparing `weight` in the resampled `boot_sample` with the original sample `almonds_sample_100`.", purl=FALSE, fig.height=ifelse(knitr::is_latex_output(), 4.2, 4)}
...
```{r fig-resampling-35, fig.cap="Distribution of 35 sample means from 35 bootstrap samples."}
...
```{r fig-one-thousand-sample-means, message=FALSE, fig.cap="Histogram of 1000 bootstrap sample mean weights of almonds.", fig.height=ifelse(knitr::is_latex_output(), 4, 4)}
ggplot(boot_means, aes(x = mean_weight)) +
  geom_histogram(binwidth = 0.01, color = "white") +
  labs(x = "sample mean weight in grams")
```
...
```{r fig-infer-specify, out.width="40%", echo=FALSE, fig.cap="Diagram of the specify() verb.", purl=FALSE}
...
```{r fig-infer-generate, out.width="40%", echo=FALSE, fig.cap="Diagram of generate() replicates.", purl=FALSE}
...
```{r fig-infer-calculate, out.width="50%", echo=FALSE, fig.cap="Diagram of calculate() summary statistics.", purl=FALSE}
...
```{r fig-infer-visualize, out.width="60%", echo=FALSE, fig.cap="Diagram of visualize() results.", purl=FALSE}
...
```{r fig-bootstrap-distribution-infer, fig.height=ifelse(is_latex_output(), 1.7, 4) , fig.cap="Bootstrap distribution.", purl=FALSE}
...
```{r fig-infer-workflow-ci, out.width="80%", echo=FALSE, fig.cap="infer package workflow for confidence intervals.", purl=FALSE}
...
```{r fig-percentile-ci-viz, echo=FALSE, fig.cap="Percentile method 95% confidence interval shaded corresponding to potential values.", purl=FALSE, fig.height=ifelse(knitr::is_latex_output(), 2.8, 4)}
...
```{r fig-se-ci-viz, echo=FALSE, fig.show="hold", fig.cap="Standard-error method 95% confidence interval.", purl=FALSE, fig.height=ifelse(knitr::is_latex_output(), 2, 4)}
if (knitr::is_html_output()) {
  visualize(bootstrap_means) +
    shade_confidence_interval(endpoints = standard_error_ci)
} else {
...
```{r fig-bootstrap-distribution-mythbusters, echo=FALSE, fig.cap="Bootstrap distribution.", purl=FALSE, fig.height=ifelse(knitr::is_latex_output(), 2, 4)}
...
```{r fig-bootstrap-distribution-mythbusters-CI, echo=FALSE, fig.cap="Two 95\\% confidence intervals: percentile method (black) and standard error method (grey).", fig.height=2.5, purl=FALSE}
visualize(bootstrap_distribution_yawning) +
  ggtitle("") +
  shade_confidence_interval(
