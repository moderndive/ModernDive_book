...
### Additional remarks: empirical coverage of bootstrap CIs {.unnumbered}
...
```{webr-r}
# your code here — be patient, this loop simulates 600 CIs total
```

### Two-sample CIs (case study: yawning) {.unnumbered}
