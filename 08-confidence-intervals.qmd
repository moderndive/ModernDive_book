...
```{r sample-mean-100-with-normal-redraw, echo=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), 1.9, 4), fig.cap="The distribution of the sample mean.", purl=FALSE}
...
```{r normal-curves, echo=FALSE, fig.cap="Three normal distributions.", purl=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), 1, 4)}
all_points <- tibble(
...
```{r normal-curve-shaded-1a, echo=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), .9, 4), fig.width=3, fig.cap="Normal area within one standard deviation."}
...
```{r normal-curve-shaded-2a, echo=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), 0.9, 4), fig.width=3, fig.cap="Normal area within two standard deviations."}
ggplot(data = data.frame(x = c(-4, 4)), aes(x)) +
  stat_function(fun = dnorm, args = list(mean = 0, sd = 1)) +
...
```{r normal-curve-1, echo=FALSE, fig.cap="Normal density curve for the sample mean weight of almonds.", purl=FALSE, out.width="90%", warning=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), 3, 4)}
...
```{r t-curve-1, echo=FALSE, fig.cap="The standard normal and two t-distributions.", purl=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), 2.5, 4)}
...
```{r almond-mean-cis, fig.cap="(ref:almond-mean-ci)", echo=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), 5, 5), purl=FALSE}
set.seed(202)
...
```{r normal-curve-shaded-3a, echo=FALSE, fig.cap="Normal curve with the shaded middle area being 0.95", fig.height=ifelse(knitr::knitr::is_latex_output(), 1.5, 4), fig.width=3}
ggplot(data = data.frame(x = c(-4, 4)), aes(x)) +
  stat_function(fun = dnorm, args = list(mean = 0, sd = 1)) +
...
```{r origandresample, echo=FALSE, fig.cap="(ref:compare-plots)", purl=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), 4.2, 4)}
...
```{r one-thousand-sample-means, message=FALSE, fig.cap="Histogram of 1000 bootstrap sample mean weights of almonds.", fig.height=ifelse(knitr::knitr::is_latex_output(), 4, 4)}
ggplot(boot_means, aes(x = mean_weight)) +
  geom_histogram(binwidth = 0.01, color = "white") +
  labs(x = "sample mean weight in grams")
```
...
```{r percentile-ci-viz, echo=FALSE, fig.cap="(ref:perc-ci-viz)", purl=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), 2.8, 4)}
if (knitr::knitr::is_html_output()) {
  visualize(bootstrap_means) +
    shade_confidence_interval(endpoints = percentile_ci)
} else {
  visualize(bootstrap_means) +
...
```{r se-ci-viz, echo=FALSE, fig.show="hold", fig.cap="(ref:se-viz)", purl=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), 2, 4)}
if (knitr::knitr::is_html_output()) {
  visualize(bootstrap_means) +
    shade_confidence_interval(endpoints = standard_error_ci)
} else {
...
```{r bootstrap-distribution-mythbusters, echo=FALSE, fig.cap="Bootstrap distribution.", purl=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), 2, 4)}
...
```{r echo=FALSE, results="asis", purl=FALSE}
if (knitr::knitr::is_latex_output()) {
