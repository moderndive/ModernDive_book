...
movies_ex %>%
  slice(1:10)
```
```{r appendixC-3, echo=FALSE, purl=FALSE}
...
```{r appendixC-11, fig.height=3, fig.width=5}
movies_ex <- movies_ex %>%
...
```{r appendixC-12, fig.height=3, fig.width=5}
...
```{r appendixC-23, warning=FALSE, out.width="100%"}
library(dygraphs)
library(nycflights23)
