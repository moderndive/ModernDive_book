...
```{r sampling-distribution-part-deux, fig.show="hold", fig.cap="Previously seen sampling distribution of the sample proportion red based on 1000 samples of size $n = 50$.", fig.height=2}
...
```{r bootstrap-distribution-part-deux, echo=FALSE, fig.show="hold", fig.cap="Bootstrap distribution of the proportion red based on 1000 resamples of size $n = 50$.", purl=FALSE, fig.height=2.5}
...
$$
\begin{aligned}
0.42 \pm `r qnorm(0.975) %>% round(2)` \cdot 0.0698 &= 0.42 \, \pm \, 0.137 \\ &= (0.42 - 0.137, \, 0.42 + 0.137) \\ &= (0.283, \, 0.557).
\end{aligned}
$$
