...
gives a comparison between the theory-based approach and the simulation-based 
approach when working with confidence intervals. The presentation is more 
...
application of the bootstrap methods in R.
...
Appendixes online and also present simulations that show when these methods 
