...
```{r infer-generate, fig.align='center', out.width='50%', out.height='50%', echo=FALSE, fig.cap="Diagram of generate() replicates.", purl=FALSE}
...
```{r infer-calculate, fig.align='center', out.width='50%', echo=FALSE, fig.cap="Diagram of calculate() summary statistics.", purl=FALSE}
...
Did Ilyas and Yohan's net capture the fish? Did their 95% confidence interval for $p$ based on their sample contain the true value of $p$ of 0.375? Yes! `r p_red` is between the endpoints of our confidence interval (`r percentile_ci_1[[1]]`, `r percentile_ci_1[[2]]`).
...
```{r reliable-percentile, fig.cap='(ref:reliable-perc)', echo=FALSE, fig.height=3.4}
...
```{r reliable-se, fig.cap='(ref:rel-se)', echo=FALSE, fig.height=4.2}
