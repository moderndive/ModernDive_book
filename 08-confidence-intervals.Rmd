...
$$
\begin{aligned}
\text{MoE} &= `r qnorm(0.975) %>% round(2)` \cdot \text{SE} =  `r qnorm(0.975) %>% round(2)` \cdot \sqrt{\frac{\widehat{p}(1-\widehat{p})}{n}} = `r qnorm(0.975) %>% round(2)` \cdot \sqrt{\frac{0.41(1-0.41)}{2089}} \\
&= `r qnorm(0.975) %>% round(2)` \cdot 0.0108 = 0.021 = 2.1\%
\end{aligned}
$$
