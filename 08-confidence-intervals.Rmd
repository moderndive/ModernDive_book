...
```{r tactile-resampling-6, echo=TRUE, fig.cap="Distribution of 35 sample means from 35 resamples.", purl=FALSE, fig.height=5}
...
<!--
TODO: infer observed point estimate computation
