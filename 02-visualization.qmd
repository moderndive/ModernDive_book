...
::: {.callout-tip collapse="true" title="Show answer"}
**(c)** Histograms show the distribution (counts in bins) of one numerical variable. Barplots are for categorical variables; scatterplots show two numerical variables; linegraphs are for sequential x-axis data (often time).
:::
