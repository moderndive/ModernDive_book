...
```{r drinks-smaller, fig.cap="Comparing alcohol consumption in 4 countries.", fig.height=ifelse(knitr::knitr::is_latex_output(), 3.9, 4), echo=FALSE, purl=FALSE}
...
```{r drinks-smaller-tidy-barplot, echo=FALSE, fig.cap="(ref:drinks-col)", fig.height=ifelse(knitr::knitr::is_latex_output(), 2.5, 4), purl=FALSE}
if (knitr::is_html_output()) {
  drinks_smaller_tidy_plot
} else {
  drinks_smaller_tidy_plot + scale_fill_grey()
...
```{r guat-dem-tidy, fig.cap="Democracy scores in Guatemala 1952-1992.", fig.height=ifelse(knitr::knitr::is_latex_output(), 3, 4)}
