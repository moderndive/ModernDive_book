...
Which exploratory visualization of the interaction model is better, the one in Figure Figure \@ref(fig:house-price-interaction) or Figure \@ref(fig:house-price-interaction-2)? There is no universal right answer, you need to make a choice depending on what you want to convey, and own it.
...
```{r}
model_price <- lm(log10_price ~ log10_size * condition, data = house_prices)
