...
```{webr-r}
library(infer)
episodes_sub <- read.csv("https://raw.githubusercontent.com/moderndive/ModernDive_book/v2-quarto-html/data/steves_episodes.csv")
episodes_sub <- subset(episodes_sub, !is.na(imdb_rating) & !is.na(overall_episode))
obs_corr <- episodes_sub |>
  specify(imdb_rating ~ overall_episode) |>
  calculate(stat = "correlation")
set.seed(2018)
