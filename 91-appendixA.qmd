...
```{r normal-curves2, echo=FALSE, fig.cap="Three normal distributions.", out.width="90%"}
all_points <- tibble(
...
```{r normal-rule-of-thumb, echo=FALSE, fig.cap="Rules of thumb about areas under normal curves.", out.width = "80%"}
