...
### Inference for multiple linear regression for the house prices example {#house-prices-inference-for-regression}

Let's next check the results of our multiple linear regression on house prices using both theory-based methods as well as simulation-based methods with a focus on hypothesis testing.
