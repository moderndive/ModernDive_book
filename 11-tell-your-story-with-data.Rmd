...
```{r tell-your-story-with-data-1, message=FALSE}
library(tidyverse)
library(moderndive)
...
```{r tell-your-story-with-data-2, message=FALSE, echo=FALSE, purl=FALSE}
...
```{r tell-your-story-with-data-3, eval=FALSE}
View(house_prices)
glimpse(house_prices)
```
```{r tell-your-story-with-data-4, echo=FALSE, purl=FALSE}
glimpse(house_prices)
```
...
```{r tell-your-story-with-data-5, eval=FALSE}
...
```{r tell-your-story-with-data-6, eval=FALSE}
house_prices |> 
...
```{r tell-your-story-with-data-7, echo=FALSE}
house_prices |> 
  select(price, sqft_living, condition) |> 
  tidy_summary() |> 
...
```{r tell-your-story-with-data-8, eval=FALSE, message=FALSE}
...
```{r tell-your-story-with-data-9, echo=FALSE, results="asis"}
if(!is_latex_output()) 
...
```{r tell-your-story-with-data-10}
...
```{r tell-your-story-with-data-11}
house_prices |> 
...
```{r tell-your-story-with-data-12, eval=FALSE}
...
```{r tell-your-story-with-data-13, eval=FALSE}
# Before log10 transformation:
ggplot(house_prices, aes(x = sqft_living)) +
  geom_histogram(color = "white") +
...
```{r tell-your-story-with-data-14, eval=FALSE}
...
```{r tell-your-story-with-data-15, eval=FALSE}
ggplot(house_prices, 
       aes(x = log10_size, y = log10_price, col = condition)) +
...
```{r tell-your-story-with-data-17, eval=FALSE}
...
```{r tell-your-story-with-data-18, echo=FALSE, purl=FALSE}
...
```{r tell-your-story-with-data-19, echo=FALSE, purl=FALSE}
# This code is used for dynamic non-static in-line text output purposes
ex_condition <- 5L
ex_size <- 1900L
...
```{r tell-your-story-with-data-21, echo=FALSE, results="asis"}
if(!is_latex_output()) 
...
```{r tell-your-story-with-data-23, eval=FALSE}
price_interaction <- lm(log10_price ~ log10_size * condition, data = house_prices)
get_regression_table(price_interaction)
```
...
```{r tell-your-story-with-data-24}
...
```{r tell-your-story-with-data-25, eval=FALSE}
...
```{r tell-your-story-with-data-26, echo=FALSE}
...
```{r tell-your-story-with-data-27, eval=FALSE}
...
```{r tell-your-story-with-data-28, echo=FALSE, message=FALSE}
...
```{r tell-your-story-with-data-29, echo=FALSE, out.width="90%"}
if(is_latex_output())
  knitr::include_graphics("images/null_housing_shaded.png")
```

```{r tell-your-story-with-data-30, echo=FALSE, fig.height=12}
if(is_html_output())
  null_housing_shaded
```
...
```{r tell-your-story-with-data-32}
...
```{r tell-your-story-with-data-33}
...
```{r tell-your-story-with-data-34}
US_births_1999 |> 
  arrange(desc(births))
```
...
```{r tell-your-story-with-data-36, echo=FALSE}
...
```{r tell-your-story-with-data-37, echo=FALSE, results='asis'}
if(!is_latex_output()){
