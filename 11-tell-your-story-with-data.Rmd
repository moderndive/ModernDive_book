...
```{r pipeline-figure-conclusion, fig.cap="Data/science pipeline.", out.height="80%", out.width="80%", echo=FALSE, purl = FALSE}
...
```{r house-price-interaction-3, echo=FALSE, message=FALSE, fig.cap="Interaction model with prediction.", fig.height=ifelse(knitr::is_latex_output(), 4.5, 5), purl=FALSE}
