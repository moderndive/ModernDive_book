...
```{r house-prices-viz, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Exploratory visualizations of Seattle house prices data.", fig.height=4}
...
```{r us-births, fig.cap="Number of births in US in 1999.", fig.height=4.2, fig.align='center'}
