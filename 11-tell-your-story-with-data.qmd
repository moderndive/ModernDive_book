...
```{r fig-moderndive-figure-conclusion, echo=FALSE, out.width="100%", fig.cap="*ModernDive* flowchart.", purl=FALSE}
...
```{r fig-pipeline-figure-conclusion, fig.cap="Data/science pipeline.", out.width="80%", echo=FALSE, purl = FALSE}
...
```{r fig-house-prices-viz, echo=FALSE, message=FALSE, fig.cap="Exploratory visualizations of Seattle house prices data.", fig.height=ifelse(knitr::is_latex_output(), 4.8, 5), purl=FALSE}
...
```{r fig-log10-price-viz, echo=FALSE, message=FALSE, fig.cap="House price before and after log10 transformation.", fig.height=ifelse(knitr::is_latex_output(), 2.3, 4), purl=FALSE}
p1 <- ggplot(house_prices, aes(x = price)) +
  geom_histogram(color = "white") +
  labs(x = "price (USD)", title = "House price: Before")
...
```
```{r fig-log10-size-viz, echo=FALSE, message=FALSE, fig.cap="House size before and after log10 transformation.", fig.height=ifelse(knitr::is_latex_output(), 2.3, 4), purl=FALSE}
...
ggplot(house_prices, 
  ...
  labs(y = "log10 price", 
       ...
       title = "House prices in Seattle")
```
```{r fig-house-price-parallel-slopes, echo=FALSE, message=FALSE, fig.cap="Interaction and parallel slopes models.", purl=FALSE}
interaction <-
  ggplot(
    house_prices,
    aes(x = log10_size, y = log10_price, col = condition)
...
```{r fig-house-price-interaction-2, echo=FALSE, message=FALSE, fig.cap="Faceted plot of interaction model.", purl=FALSE}
...
```{r fig-house-price-interaction-3, echo=FALSE, message=FALSE, fig.cap="Interaction model with prediction.", fig.height=ifelse(knitr::is_latex_output(), 5, 5), purl=FALSE}
...
```{r fig-us-births, fig.cap="Number of births in the US in 1999.", fig.height=ifelse(knitr::is_latex_output(), 6.4, 7)}
