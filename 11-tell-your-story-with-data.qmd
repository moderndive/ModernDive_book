...
opts_chunk$set(
  ...
  purl = TRUE,
  out.width = "\\textwidth",
  fig.height = ifelse(knitr::knitr::is_latex_output(), 4, 7),
  fig.align = "center"
)
...
```{r house-prices-viz, echo=FALSE, message=FALSE, fig.cap="Exploratory visualizations of Seattle house prices data.", fig.height=ifelse(knitr::knitr::is_latex_output(), 4.8, 5), purl=FALSE}
...
```{r log10-price-viz, echo=FALSE, message=FALSE, fig.cap="House price before and after log10 transformation.", fig.height=ifelse(knitr::knitr::is_latex_output(), 2.3, 4), purl=FALSE}
p1 <- ggplot(house_prices, aes(x = price)) +
  geom_histogram(color = "white") +
  labs(x = "price (USD)", title = "House price: Before")
...
```
```{r log10-size-viz, echo=FALSE, message=FALSE, fig.cap="House size before and after log10 transformation.", fig.height=ifelse(knitr::knitr::is_latex_output(), 2.3, 4), purl=FALSE}
...
```{r house-price-interaction-3, echo=FALSE, message=FALSE, fig.cap="Interaction model with prediction.", fig.height=ifelse(knitr::knitr::is_latex_output(), 5, 5), purl=FALSE}
...
```{r us-births, fig.cap="Number of births in the US in 1999.", fig.height=ifelse(knitr::knitr::is_latex_output(), 6.4, 7)}
