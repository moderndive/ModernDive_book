...
\begin{verbatim}
<<<<<<< HEAD:ismaykim.tex
## [1] "By Chester on Wednesday, November 16, 2016 12:58:15 PST"
=======
## [1] "By cismay on Wednesday, November 16, 2016 11:54:46 PST"
>>>>>>> d23702f629aeb1f42162a03aceeae0b63177a681:docs/ismaykim.tex
\end{verbatim}
...
\StringTok{  }\KeywordTok{resample}\NormalTok{(}\DecValTok{34} \NormalTok{*}\StringTok{ }\DecValTok{2}\NormalTok{, }\DataTypeTok{replace =} \OtherTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
##     genre     mean  std_dev
##     <chr>    <dbl>    <dbl>
## 1  Action 4.858537 1.529865
## 2 Romance 6.188889 1.086396
\end{verbatim}
...
\(\bar{x}_r - \bar{x}_a = 6.1888889 - 4.8585366 = 1.3303523\). We will
...
difference of 1.3303523 falls on this null/randomization distribution.
...
observed difference in means was 1.3303523. It falls far outside the
...
mean rating for romance movies is between 1.267 and 1.394 points higher
