...
tactile_histogram <- ggplot(tactile_resample_means, mapping = aes(x = stat)) +
  geom_histogram(binwidth = 1, color = "white", boundary = 1990) +
  scale_x_continuous(breaks = seq(1990, 2000, 2))
tactile_histogram + 
...
<!-- Modify the below passage to reinforce learning about resampling and
motivate simulation -->
...
<!-- Albert will make sure sampling-goal is defined as a section or remove the reference above. -->
...
<!-- Need to remove this as we are avoiding `pennies` now. -->
