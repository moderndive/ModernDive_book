...
Both methods return `r p_red` as the proportion of red balls in the population of all balls in the bowl. So did our "95% confident" guess above of $[`r round(bootstrap_props[["lower"]], 2)`, `r round(bootstrap_props[["upper"]], 2)`]$ contain the "true value" for the population?
...
We've repeated the processes above 
