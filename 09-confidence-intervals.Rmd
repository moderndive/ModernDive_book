...
Each of the pennies was numbered as 1-50 starting in the top left and ending in the bottom right progressing row by row. This is shown with the "ID" values on top of and near the middle of each penny for clarity. The year of mint is also shown on top of and to the rightside of the penny as well.
...
1. First, pretend that each of the 40 values of `year` in `pennies_sample_2` were written on a small piece of paper. Recall that these values were 6, 30, 34, 19, 6, etc.
