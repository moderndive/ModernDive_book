...
if(!file.exists("rds/balls_perc_cis.rds")){
  ...
  saveRDS(object = pennies_cis, "rds/balls_perc_cis.rds")
} else {
  pennies_cis <- readRDS("rds/balls_perc_cis.rds")
}
...
#### The impact of changing confidence levels
...
Let's play with a few examples here to drill this idea home. We can also observe the impact of sample size on these calculations and make some generalizations.
