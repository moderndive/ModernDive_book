...
Thus using our 95% rule of thumb about normal distributions from Appendix \@ref(appendixA), we can use the following formula to determine the lower and upper endpoints of the 95% confidence interval for $\mu$:
