...
To further accentuate this point, let's perform a similar procedure using 85% standard-error based confidence intervals instead. Let's visualize the results in Figure \@ref(fig:reliable-se).
