...
# This code is used for dynamic non-static in-line text output purposes
africa_life_exp <- lifeExp_model$coefficients[[1]] %>% round(1)
```
...
1. `intercept` corresponds to the mean life expectancy of countries in Africa of `r africa_life_exp` years.
