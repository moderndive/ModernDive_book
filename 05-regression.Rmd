...
```{r correlation1, echo=FALSE, fig.cap="Nine different correlation coefficients.", fig.height=ifelse(knitr::is_latex_output(), 3.2, 7), purl=FALSE}
...
```{r numxplot1, fig.cap="Scatterplot of relationship of life expectancy and fertility rate", fig.height=ifelse(knitr::is_latex_output(), 4.5, 7)}
ggplot(UN_data_ch5, 
...
```{r numxplot3, fig.cap="Scatterplot of life expectancy and fertility rate with regression line.", message=FALSE, fig.height=ifelse(knitr::is_latex_output(), 4, 7)}
...
* Square: The *fitted value* $\widehat{y}$ is the value on the regression line for $x = $ `life_exp` $ = `r x`$, computed with the intercept and slope in the previous regression table: 
...
```{r numxplot4, echo=FALSE, fig.cap="Example of observed value, fitted value, and residual.", fig.height=ifelse(knitr::is_latex_output(), 3.4, 7), message=FALSE, purl=FALSE}
...
```{r lifeexp2022hist, echo=TRUE, fig.cap="Histogram of life expectancy in 2022.", fig.height=ifelse(knitr::is_latex_output(), 5.2, 7)}
...
```{r catxplot0b, echo=FALSE, fig.cap="Life expectancy in 2022 by continent (faceted).", fig.height=ifelse(knitr::is_latex_output(), 4, 7), purl=FALSE}
...
```{r catxplot1, fig.cap="Life expectancy in 2022 by continent (boxplot).", fig.height=ifelse(knitr::is_latex_output(), 2, 7)}
...
$$
\begin{aligned}
\widehat{\text{life exp}} &= `r intercept` + `r offset_asia`\cdot 0 + `r offset_europe`\cdot 0 + `r offset_north_america`\cdot 0 + `r offset_oceania`\cdot 0 + `r offset_south_america`\cdot 1\\
...
```{r best-fitting-line, fig.height=ifelse(knitr::is_latex_output(), 5.7, 7), echo=FALSE, fig.cap="Example of observed value, fitted value, and residual.", purl=FALSE, message=FALSE}
# First residual
