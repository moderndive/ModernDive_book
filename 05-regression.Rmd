...
* -1 indicates a perfect *negative relationship*: As one variable increases, the value of the other variable tends to go down following along a straight line.
...
```{r correlation1, echo=FALSE, fig.cap="Different correlation coefficients.", fig.height=2.6}
...
An alternative way to compute correlation is to use the `cor()` function within a `summarize()`:
...
```{r moderndive-figure-wrapper, echo=FALSE, fig.align='center', fig.cap="The concept of a wrapper function.", out.height="70%", out.width="70%"}
...
```{r moderndive-figure-causal-graph-2, echo=FALSE, fig.align='center', fig.cap="Does sleeping with shoes on cause headaches?", out.width="80%", out.height="80%"}
