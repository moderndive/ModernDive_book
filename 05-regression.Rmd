...
**`r paste0("(LC", chap, ".", (lc <- lc + 1), ")")`** What does the intercept term $b_0$ represent in a simple linear regression model? 
...
**`r paste0("(LC", chap, ".", (lc <- lc + 1), ")")`** Which of the following best describes the "slope" of a simple linear regression line?  
...
**`r paste0("(LC", chap, ".", (lc <- lc + 1), ")")`** When interpreting the slope of a simple linear regression line, which of the following is correct?

- A. The slope indicates how much the outcome variable changes for a one-unit increase in the explanatory variable.
- B. The slope indicates the average value of the explanatory variable.
- C. The slope is always equal to the correlation coefficient.
- D. The slope indicates the maximum value of the outcome variable.
...
```{r lifeexp2022hist, echo=TRUE, fig.cap="Histogram of life expectancy in 2022.", fig.height=ifelse(knitr::is_latex_output(), 5.2, 7), fig.pos='H'}
...
- C. It shows how much higher or lower the mean of this group is compared to the baseline group
- D. It has no practical interpretation

**`r paste0("(LC", chap, ".", (lc <- lc + 1), ")")`** Which of the following statements about residuals in regression is true?  
    
- A. A residual measures the difference between the predicted and observed values
