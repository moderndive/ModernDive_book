...
── Variable type:numeric
 variable n_missing complete_rate mean   sd   p0  p25  p50 p75 p100
  bty_avg         0           463 4.42 1.53 1.67 3.17 4.33 5.5 8.17
    score         0           463 4.17 0.54 2.3  3.8  4.3  4.6 5   
```
<!--
TODO: 
...
- `complete_rate`: the rate of non-missing or complete values
- `mean`: the average
...
Looking at this output, we can see how the values of both variables distribute. For example, the mean teaching score was 4.17 out of 5, whereas the mean "beauty" score was 4.42 out of 10. Furthermore, the middle 50% of teaching scores was between 3.8 and 4.6 (the first and third quartiles), whereas the middle 50% of "beauty" scores falls within 3.17 to 5.5 out of 10.
...
── Variable type:factor
 ...
 continent         0           142 FALSE          5 Afr: 52, Asi: 33, Eur: 30, Ame: 25

── Variable type:numeric
 variable n_missing complete_rate  mean    sd    p0   p25   p50   p75 p100
  lifeExp         0           142 67.01 12.07 39.61 57.16 71.94 76.41 82.6
```
...
- `n_missing` and `complete_rate`, which are the number of missing and complete rate of values as before, respectively.
