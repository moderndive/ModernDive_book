...
Table: (\#five-random-countries) A random sample of 5 out of the 193 total countries (181 without missing data)
...
- `missing`, `complete_rate`, and `n`,  which are the number of missing, complete, and total number of values as before, respectively.
