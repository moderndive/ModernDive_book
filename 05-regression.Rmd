...
(Note that for formatting purposes in this book, the inline histogram that is usually printed with `skim()` has been removed. This removal can be done by running `skim_with(numeric = list(hist = NULL))` prior to using the `skim()` function as well.)
