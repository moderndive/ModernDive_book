...
```{r load-mvtnorm, message=FALSE, echo=FALSE, purl=FALSE}
...
```
```{r model-1, echo=FALSE, purl=FALSE}
...
```{r this-code-is-used-for-dynamic, echo=FALSE, purl=FALSE}
# This code is used for dynamic non-static in-line text output purposes
...
```{r summarize-2, eval=TRUE, results='hide'}
