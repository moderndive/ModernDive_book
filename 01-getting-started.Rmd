...
```{r echo=FALSE, fig.cap="(ref:ismay-book)", purl=FALSE, out.width=if(!knitr::is_latex_output()) "100%"}
# out.height=if(is_latex_output()) "60%"
...
```{r moderndive-flowchart, echo=FALSE, fig.cap="(ref:flowchart2)", out.width="60%", out.height="60%", purl=FALSE}
