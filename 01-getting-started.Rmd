...
(ref:ismay-book) Preview of *Getting used to R, RStudio, and R Markdown* book.

```{r echo=FALSE, fig.align='center', fig.cap="(ref:ismay-book)", out.height=if(knitr:::is_latex_output()) '2in', purl=FALSE}
