...
```{r echo=FALSE, fig.align='center', fig.cap="Installing packages in R the easy way.", out.width=ifelse(knitr:::is_latex_output(), '4in', '70%'), purl=FALSE}
knitr::include_graphics("images/install_packages_easy_way.png")
```     

An alternative but slightly less convenient way to install a package is by typing `install.packages("ggplot2")` in the console pane of RStudio and pressing Return/Enter on your keyboard. Note you must include the quotation marksaround the name of the package..
