...
The `nycflights23` package is an updated version of [the classic `nycflights13` R package](https://nycflights13.tidyverse.org/). `nycflights23` was authored by ModernDive co-author Chester Ismay using the [`anyflights` R package](https://anyflights.netlify.app/) developed by Simon Couch. Simon granted permission to the ModernDive team to use the data in the `anyflights` package to create `nycflights23` and submit the package to CRAN.
