...
```{r getting-started-1, message=FALSE, echo=FALSE, purl=FALSE}
...
```{r getting-started-2, results="asis", echo=FALSE, purl=FALSE}
...
```{r getting-started-3, eval=FALSE}
library(ggplot2)
```
...
```{r getting-started-4, message=FALSE}
...
```{r getting-started-5, echo=FALSE, purl=FALSE}
...
```{r getting-started-7, eval=FALSE}
airlines
kable(airlines)
```
...
```{r getting-started-11, echo=FALSE, results="asis", purl=FALSE}
if (is_latex_output()) {
