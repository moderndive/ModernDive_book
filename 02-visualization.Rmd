...
```{r filter-1, echo=FALSE, purl=FALSE}
...
```{r plot-4, echo=FALSE, purl=FALSE, message=FALSE}
...
```{r plot-5, geomcol, fig.cap="Barplot when counts are pre-counted.", fig.height=ifelse(knitr::is_latex_output(), 1.3, 4)}
