...
```{r facethistogram, fig.cap="Faceted histogram of hourly temperatures by month.", echo=FALSE}
...
```{r facethistogram2, fig.cap="Faceted histogram with 4 instead of 3 rows.", echo=FALSE}
...
Alternatively, say you had a data frame where the number of flights for each `carrier` was pre-counted as in Table \@ref(tab:flights-counted).
...
```{r facet-bar-vert, fig.cap="Faceted barplot comparing the number of flights by carrier and origin.", fig.height=7.5, echo=FALSE}
