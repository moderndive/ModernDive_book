...
The resulting Figure \@ref(fig:monthtempbox) shows 12 separate "box and whiskers" plots similar to the right-most plot of Figure \@ref(fig:nov2) of only November temperatures. The the different boxplots are shown "side-by-side."
