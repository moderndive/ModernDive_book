...
```{r visualization-1, echo=FALSE, results="asis", purl=FALSE}
if (is_latex_output()) {
...
```{r visualization-3, message=FALSE, echo=FALSE, purl=FALSE}
...
```{r visualization-4, echo=FALSE, purl=FALSE}
...
```{r visualization-5, echo=FALSE, purl=FALSE, results="asis"}
if (is_latex_output()) {
...
```{r visualization-6, echo=FALSE}
envoy_flights <- flights |> 
  filter(carrier == "MQ")
```

```{r visualization-7, eval=FALSE}
...
```{r visualization-13, echo=FALSE, purl=FALSE}
...
```{r visualization-15, echo=FALSE, purl=FALSE}
...
```{r visualization-17, geomcol, fig.cap="Barplot when counts are pre-counted.", fig.height=ifelse(knitr::is_latex_output(), 1.3, 4)}
...
```{r visualization-25, echo=FALSE, results="asis", purl=FALSE}
if (is_latex_output()) {
...
```{r visualization-27, purl=FALSE, echo=FALSE}
# This redundant code is used for dynamic non-static in-line text output purposes
