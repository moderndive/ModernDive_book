...
```{r visualization-conditional-text-2, echo=FALSE, purl=FALSE, results="asis"}
if (is_latex_output()) {
...
```{r visualization-hist-wind-2, eval=FALSE}
ggplot(data = weather, mapping = aes(x = wind_speed)) +
...
```{r visualization-hist-wind-3, eval=FALSE}
ggplot(data = weather, mapping = aes(x = wind_speed)) +
...
```{r visualization-facet-hist-wind-2, eval=FALSE}
ggplot(data = weather, mapping = aes(x = wind_speed)) +
  geom_histogram(binwidth = 5, color = "white") +
...
```{r visualization-14, echo=FALSE, purl=FALSE, message=FALSE}
...
```{r visualization-bar-2, eval=FALSE}
ggplot(data = flights, mapping = aes(x = carrier)) + 
  geom_bar()
```
...
```{r visualization-bar-3, eval=FALSE}
...
```{r visualization-bar-4, eval=FALSE}
...
```{r visualization-bar-5, eval=FALSE}
ggplot(data = flights, mapping = aes(x = carrier), fill = origin) +
  geom_bar()
```
...
```{r visualization-bar-6, eval=FALSE}
ggplot(data = flights, mapping = aes(x = carrier, fill = origin)) +
...
```{r visualization-bar-7, eval=FALSE}
# Segment 1:
ggplot(data = flights, mapping = aes(x = carrier)) +
  geom_bar()
...
```{r visualization-conditional-text-3, echo=FALSE, results="asis", purl=FALSE}
if (is_latex_output()) {
...
```{r visualization-26, echo=FALSE, purl=FALSE, results="asis"}
...
```{r visualization-filter-envoy-2, purl=FALSE, echo=FALSE}
# This redundant code is used for dynamic non-static in-line text output purposes
...
```{r visualization-filter-month-2, eval=FALSE}
