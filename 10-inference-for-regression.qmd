...
```{r inference-for-regression-create-model_1, echo=FALSE, purl=FALSE}
# Fit regression model:
model_1 <-  lm(waiting ~ duration, data = old_faithful_2024)
...
```{r inference-for-regression-create-model_1-v2, echo=FALSE, purl=FALSE}
# Fit regression model:
model_1 <-  lm(waiting ~ duration, data = old_faithful_2024)
b_coef <- round(coef(model_1),2)
# Get the coefficients of the model
...
```{r equal-variance-residuals, echo=FALSE, fig.cap="Example of clearly non-equal variance.", purl=FALSE, fig.height=ifelse(knitr::is_latex_output(), 2, 4)}
old_faithful_2024 |>
...
coffee_data |>
  ...
  kable_styling(
    font_size = ifelse(knitr::is_latex_output(), 7, 16),
    latex_options = c("HOLD_position")
  )
```
...
```{r inference-for-regression-create-mod_mult_1, echo=FALSE, purl=FALSE}
# Fit regression model:
mod_mult_1 <- lm(
  total_cup_points ~ aroma + flavor + moisture_percentage, 
  data = coffee_data)
...
```{r inference-for-regression-create-mod_mult_2, echo=FALSE, purl=FALSE}
# Fit regression model:
mod_mult_2 <- lm(
  total_cup_points ~ aroma + moisture_percentage, data = coffee_data)
# Get the coefficients of the model
...
```{r inference-for-regression-mult-model-sized, echo=FALSE, purl=FALSE}
...
```{r inference-for-regression-mult-model-alt2, echo=FALSE, purl=FALSE}
...
```{r inference-for-regression-mult-model-v4, echo=FALSE, purl=FALSE}
...
```{r inference-for-regression-mult-model-v5, echo=FALSE, purl=FALSE}
