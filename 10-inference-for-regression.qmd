...
```{r fig-geyserplot1, fig.alt="Scatterplot of waiting time (minutes) versus eruption duration (minutes) for the Old Faithful geyser. Two distinct clusters of points are visible.", echo=F, fig.cap="Scatterplot of relationship of eruption duration and waiting time.", fig.height=ifelse(knitr::is_latex_output(), 3, 4)}
