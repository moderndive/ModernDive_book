...
::: {.callout-tip collapse="true" title="Show answer"}
**(b)** When assumptions hold, the two approaches converge. Differences of this magnitude (especially when reps are limited) are normal Monte Carlo variation. Big disagreements would be a red flag — usually that LINE is violated, in which case the simulation-based result is more trustworthy.
:::
