...
```{r regline-ch10, fig.cap="Relationship with regression line.", fig.height=ifelse(knitr::knitr::is_latex_output(), 3, 4), message=FALSE}
...
```{r geyserplot1, echo=F, fig.cap="Scatterplot of relationship of eruption duration and waiting time.", fig.height=ifelse(knitr::knitr::is_latex_output(), 3, 4)}
...
```{r pop-by-genre-plot, fig.cap="Boxplot of popularity by genre.", fig.height=ifelse(knitr::knitr::is_latex_output(), 3.2, 4)}
...
```{r pvalue1, echo=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), 2, 4), fig.cap="Illustration of a two-sided p-value for a t-test."}
n <- n_old_faithful
...
```{r residual-example, echo=FALSE, fig.cap="Example of observed value, fitted value, and residual.", purl=FALSE, message=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), 2.2, 4)}
...
```{r scatt-and-residual, echo=FALSE, fig.cap="The scatterplot and residual plot for the Old Faithful data.", purl=FALSE, message=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), 2.3, 4)}
...
```{r non-linear, echo=FALSE, fig.cap="Example of a non-linear relationship.", fig.height=ifelse(knitr::knitr::is_latex_output(), 3.3, 4), message=FALSE, purl=FALSE}
set.seed(76)
...
```{r time-plot, echo=FALSE, fig.cap="Scatterplot of date (time) vs residuals for the Old Faithful example.", fig.height=ifelse(knitr::knitr::is_latex_output(), 3, 4), message=FALSE, purl=FALSE}
old_faithful_2024 |>
...
```{r not-normal-residuals, echo=FALSE, fig.cap="Non-normal residuals.", message=FALSE, purl=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), 1.4, 4)}
set.seed(3)
...
```{r residual-plot, fig.cap="Plot of residuals against the regressor.", message=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), 1.5, 4)}
...
```{r bootstrap-distribution-slope, fig.cap="Bootstrap distribution of slope.", fig.height=ifelse(knitr::knitr::is_latex_output(), 2.2, 4)}
...
```{r null-distribution-slope, echo=FALSE, fig.cap="Null distribution of slopes.", fig.height=ifelse(knitr::knitr::is_latex_output(), 2, 4), purl=FALSE}
...
```{r p-value-slope, echo=FALSE, fig.cap="Null distribution and $p$-value.", fig.height=ifelse(knitr::knitr::is_latex_output(), 3.8, 4), purl=FALSE}
visualize(null_distn_slope) +
...
```{r, grid-arrange-plot-check, fig.cap="Residuals vs. fitted values plot and QQ-plot for the multiple regression model.", fig.height=ifelse(knitr::knitr::is_latex_output(), 2, 4)}
g1 <- fit_and_res_mult |>
