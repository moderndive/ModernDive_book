...
**Q11.** Section 10.4 fits `lm(total_cup_points ~ aroma + flavor + moisture_percentage + continent_of_origin)` on the coffee data. The coefficient on `aroma` (its **partial slope**) tells you:
