...
```{r appendixC-bar-simple-v2-dup1}
revenue_by_type <- revenue_by_type %>%
...
```{r appendixC-bar-simple-v2-dup2}
revenue_by_type <- revenue_by_type %>%
  mutate(type = reorder(type, -total_revenue))
...
```{r appendixC-v11, fig.height=3, fig.width=5}
movies_ex <- movies_ex %>%
...
```{r appendixC-v12, fig.height=3, fig.width=5}
