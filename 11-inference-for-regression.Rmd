...
Let's first head back to reminding ourselves of the University of Texas Austin student evaluations analysis in Section \@ref(model1). Let's begin by looking at the `evals_ch6` data frame that selected a subset of variables from the `evals` data frame in the `moderndive` package.
