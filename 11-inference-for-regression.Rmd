...
Is there a significant relationship between teaching score and bty score above and beyond any evidence due to sampling variation.
...
### Bootstrapping the relationship
...
Values computed via simulation, done using formulas below. However interpretation
remains the same. 
...
* Linearity
* Normality via histogram
* Constant variance via partial residual plots
* Independence. Point to Gelman's 8 schools example


---

## Case study: Teaching evals
...
Same as Regression with categorical variables

### Theory: Gauss-Markov theorem
### Formula: Regression

* Point estimate formulas
* SE formulas. Focus on $\sqrt{n}$
