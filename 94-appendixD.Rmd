...
# Fit regression model:
price_interaction <- lm(log10_price ~ log10_size, 
                        data = house_prices)

# Get regression table:
get_regression_table(price_interaction)

10^(2.447	+ 1*log10(1900))
```
<!--
TODO:sosssss
-->
...
The dates with the fewest number of births in the US was 12/25 of the years of 2001, 2000, 2003, 2002, and 1999. It is Christmas Day. 
