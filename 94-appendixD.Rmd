...
```{r appendixD-2, child = "lc-answers/02_lc-answers.Rmd"}
```
...
```{r appendixD-3, child = "lc-answers/03_lc-answers.Rmd"}
```
...
```{r appendixD-4, child = "lc-answers/04_lc-answers.Rmd"}
```
...
```{r appendixD-5, child = "lc-answers/05_lc-answers.Rmd"}
```
...
```{r appendixD-6, child = "lc-answers/06_lc-answers.Rmd"}
```
...
```{r appendixD-7, child = "lc-answers/07_lc-answers.Rmd"}
```
...
```{r appendixD-8, child = "lc-answers/08_lc-answers.Rmd"}
```
...
```{r appendixD-9, child = "lc-answers/09_lc-answers.Rmd"}
```
...
```{r appendixD-10, child = "lc-answers/10_lc-answers.Rmd"}
```
...
```{r appendixD-11, child = "lc-answers/11_lc-answers.Rmd"}
```
...
```{r appendixD-12, child = "lc-answers/A1_lc-answers.Rmd"}
```
