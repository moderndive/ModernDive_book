...
**`r paste0("(LC", chap, ".", (lc <- lc + 1), ")")`** In the case of our bowl activity, what is the *population parameter*? Do we know its value?
  ...
  **Solution**: 
  ...
  The *population parameter* in the case of our bowl activity is the population proportion of the red balls in the hopper. No, we would like to know its value. 
