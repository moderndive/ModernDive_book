...
```{r foreword-show-ModernDive-heart, fig.alt="ModernDive logo — the word *ModernDive* with a stylized heart graphic, evoking the book's blend of statistics and data science.", fig.align="center", echo=FALSE, out.width="70%"}
include_graphics("images/ModernDive_heart.png")
```

My favorite aspect of *ModernDive*, if I must pick a favorite, is that students gain experience with the whole data analysis pipeline (see @fig-pipeline-figure). 
...
```{r foreword-conditional-text, echo=FALSE, results="asis"}
if (is_latex_output()) {
