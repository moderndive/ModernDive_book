...
```{r wrangling-1, message=FALSE}
library(dplyr)
library(ggplot2)
library(nycflights23)
```

```{r wrangling-2, message=FALSE, warning=FALSE, echo=FALSE, purl=FALSE}
...
```{r wrangling-3, eval=FALSE, purl=FALSE}
h(g(f(x)))
```
...
```{r wrangling-4, eval=FALSE, purl=FALSE}
x |> 
  f() |> 
  g() |> 
  h()
...
```{r filter, fig.cap="Diagram of filter() rows operation.", echo=FALSE, purl=FALSE, out.width="80%"}
...
```{r sum1, fig.cap="Diagram of summarize() rows.", echo=FALSE, purl=FALSE, out.width="80%"}
...
```{r groupsummarize, fig.cap="(ref:groupby)", echo=FALSE, purl=FALSE, out.width="90%"}
...
```{r wrangling-21, echo=FALSE, purl=FALSE}
...
```{r mutatevars, fig.cap="Diagram of mutate() columns.", echo=FALSE, purl=FALSE, out.width="40%"}
...
```{r gain-hist, fig.cap="Histogram of gain variable.", message=FALSE, fig.height=ifelse(knitr::is_latex_output(), 3, 4)}
...
```{r reldiagram, fig.cap="(ref:relationships-nycflights)", echo=FALSE, purl=FALSE, out.width="65%"}
...
```{r ijdiagram, fig.cap="(ref:inner-join-r4ds)", echo=FALSE, purl=FALSE, out.width="80%"}
...
```{r selectfig, fig.cap="Diagram of select() columns.", echo=FALSE, purl=FALSE, out.width="70%"}
include_graphics("images/cheatsheets/select.png")
```

```{r wrangling-43, echo=FALSE, purl=FALSE}
...
```{r wrangling-46, eval=FALSE}
flights_no_year <- flights |> select(-year)
```

Another way of selecting columns/variables is by specifying a range of columns:

```{r wrangling-47, eval=FALSE}
...
```{r available-seat-miles, fig.cap="Example of available seat miles for one flight.", echo=FALSE, purl=FALSE, out.width="60%"}
...
```{r wrangling-54, results="asis", echo=FALSE, purl=FALSE}
if(is_latex_output()){
...
```{r wrangling-55, results="asis", echo=FALSE, purl=FALSE}
generate_r_file_link("03-wrangling.R")
```

```{r wrangling-56, echo=FALSE, results="asis"}
if(!is_latex_output()) 
...
```{r dplyr-cheatsheet, fig.cap="Data Transformation with dplyr cheatsheet (first page).", echo=FALSE, purl=FALSE, out.width="100%"}
if (is_html_output()) {
