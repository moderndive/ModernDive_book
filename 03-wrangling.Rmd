...
Now say we have a larger number of airports we want to filter for, say `"SEA"`, `"SFO"`, `"PDX"`, `"BTV"`, and `"BDL"`. We could continue to use the `|` (*or*) \index{operator!or} operator:
...
```{r reldiagram, echo=FALSE, fig.cap="Data relationships in nycflights13 from R for Data Science.", purl=FALSE, out.height="120%"}
...
```{r ijdiagram, echo=FALSE, fig.cap="Diagram of inner join from R for Data Science.", purl=FALSE, out.height="120%"}
...
For example, let's consider the scenario in Figure \@ref(fig:available-seat-miles). Since the airplanes has 4 seats and it travels 200 miles, the available seat miles are 4 $\times$ 200 = 800.

```{r available-seat-miles, echo=FALSE, fig.cap="Example of available seat miles for one flight.", out.height="50%", purl=FALSE}
...
On top of the data wrangling verbs and examples we presented in this section, if you'd like to see more examples of using the `dplyr` package for data wrangling, check out [Chapter 5](http://r4ds.had.co.nz/transform.html) of _R for Data Science_ [@rds2016].
