...
Another common transformation of data is to create/compute new variables based on existing ones. For example, say you are more comfortable thinking of temperature in degrees Celsius &deg;C and not degrees Fahrenheit &deg;F. The formula to convert temperatures from &deg;F to &deg;C is:
