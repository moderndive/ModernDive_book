...
```{r gain-hist, fig.cap="Histogram of gain variable.", message=FALSE, fig.height=ifelse(knitr::knitr::is_latex_output(), 3, 4)}
...
In the current version of RStudio in 2025, you can access this cheatsheet by going to the RStudio Menu Bar -> Help -> Cheatsheets -> "Data Transformation with dplyr." `r if(knitr::is_html_output()) "You can see a preview in the figure below."`
