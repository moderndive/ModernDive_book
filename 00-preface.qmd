...
if (knitr::is_html_output()) {
  # Get version and date from index setup
  ver <- if(exists("version")) version else "2.0.0"
  dt <- if(exists("date")) date else "2024"
  cat(glue::glue('This is version {ver} of *ModernDive* published on {dt}. For previous versions of *ModernDive*, see the "About this book" section.'))
}
```
