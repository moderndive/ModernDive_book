...
* *Are you curious about the publishing of this book? Then, read the "About this book" section for more information on the open-source technology, in particular Quarto.*
...
This book was written using [Quarto](https://quarto.org/), an open-source scientific and technical publishing system. Quarto simplifies book publishing by having all content written in markdown format with embedded R code. The Quarto source code of ModernDive is available on GitHub:
