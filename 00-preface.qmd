...
```{r preface-conditional-text, results="asis", echo=FALSE}
if (is_html_output()) {
...
```{r moderndive-figure, fig.align="center", fig.cap="(ref:flowchart)", echo=FALSE, out.width="100%"}
...
```{r pipeline-figure, fig.align="center", fig.cap="Data/science pipeline.", echo=FALSE, out.width="100%"}
...
```{r preface-load-internal, message=FALSE, echo=FALSE}
