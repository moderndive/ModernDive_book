...
```{r preface-conditional-text, results="asis", echo=FALSE, purl=FALSE}
if (is_html_output()) {
...
```{r fig-moderndive-figure, fig.align="center", fig.cap="*ModernDive* flowchart.", echo=FALSE, purl=FALSE, out.width="100%"}
...
```{r fig-pipeline-figure, fig.align="center", fig.cap="Data/science pipeline.", echo=FALSE, purl=FALSE, out.width="100%"}
