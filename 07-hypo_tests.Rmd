...
Let's select a random sample of 34 action movies and a random sample of 34 romance movies.  (The number 34 was chosen somewhat arbitrarily here.)  Note that we need to use `34 * 2` or 68 here
...
knitr::purl("07-hypo_tests.Rmd", "docs/07-hypo_tests.R")
```

An R script file of all R code used in this chapter is available [here](http://ismayc.github.io/moderndiver-book/07-hypo_tests.R).
