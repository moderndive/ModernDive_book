...
**Q3.** A simulation-based hypothesis test computes the $p$-value as "share of *null* statistics at least as extreme as the observed one." For a **two-sided** alternative $H_A: \mu \neq \mu_0$, "as extreme as" means:
...
**Q11.** In Section 9.2, the metal-vs-deep-house comparison shuffled the `popular_or_not` values across the rows of `spotify_metal_deephouse` and recomputed the difference in the proportion of popular tracks each time. What is the **shuffling** simulating?
