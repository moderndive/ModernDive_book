...
```{r hypothesis-testing-load-internal, message=FALSE, echo=FALSE}
...
```{r hypo-test-1, fig.cap="The t test statistic.", echo=FALSE}
...
```{r t-curve-hypo, echo=FALSE, fig.height=ifelse(is_latex_output(), 1.5, 4), fig.width=3, fig.cap="The tails of a t curve for this hypothesis test."}
...
```{r hypothesis-testing-create-p_val, echo = FALSE}
...
```{r hypothesis-testing-conditional, eval=FALSE, echo=FALSE}
p_val_almonds |> 
  kbl(
    digits = 3,
    caption = "The p value",
...
```{r hypothesis-testing-create-bootstrap_means, echo=FALSE}
...
```{r hypothesis-testing-create-n_songs, echo=FALSE}
...
```{r spotify-genre-barplot, echo=FALSE, fig.cap="Barplot relating genre to popularity.", fig.height=ifelse(knitr::is_latex_output(), 1.6, 4)}
...
```{r hypothesis-testing-v21, echo=FALSE}
...
```{r hypothesis-testing-create-n_metal_popular_or, echo=FALSE}
# This code is used for dynamic non-static in-line text output purposes
...
```{r deck-of-cards, echo=FALSE, fig.cap="Standard deck of 52 playing cards.", out.width="60%"}
...
```{r shuffling, echo=FALSE, fig.cap="Shuffling a deck of cards.", out.width="50%"}
...
ggplot(spotify_52_shuffled, aes(x = track_genre, fill = popular_or_not)) +
  ...
  labs(x = "Genre of track")
```
```{r spotify-genre-barplot-permuted, fig.cap="Barplots of relationship of genre with `popular or not' (left) and shuffled `popular or not' (right).", fig.height=ifelse(knitr::is_latex_output(), 2.6, 4), echo=FALSE, message=FALSE}
...
spotify_52_shuffled |> 
  ...
  tally()
```
```{r hypothesis-testing-create-n_metal_popular, echo=FALSE}
# metal stats
...
```{r infer-ci, echo=FALSE, fig.cap="Confidence intervals with the infer package.", out.width="90%"}
...
```{r inferht, echo=FALSE, fig.cap="Hypothesis testing with the infer package.", out.width="90%"}
knitr::include_graphics("images/flowcharts/infer/ht.png")
```

```{r hypothesis-testing-create-alpha, echo=FALSE}
alpha <- 0.1
```
...
```{r hypothesis-testing-dynamic-text, echo=FALSE}
# This code is used for dynamic non-static in-line text output purposes
n_reps <- 1000L
```
...
```{r hypothesis-testing-null-dist-v4, echo=FALSE}
...
```{r hypothesis-testing-v35, echo=FALSE}
...
```
```{r hypothesis-testing-create-p_value, echo=FALSE}
...
```{r hypothesis-testing-null-dist-v8, echo=FALSE}
...
```
```{r bootstrap-distribution-two-prop-percentile, echo=FALSE, fig.show="hold", fig.cap="Percentile-based 90\\% confidence interval.", fig.height=ifelse(knitr::is_latex_output(), 3.2, 4)}
if (is_html_output()) {
  visualize(bootstrap_distribution) +
    shade_confidence_interval(endpoints = percentile_ci)
} else {
...
```
```{r bootstrap-distribution-two-prop-se, eval=FALSE, echo=FALSE, fig.show="hold", fig.cap="Standard error-based 95\\% confidence interval.", fig.height=3.4}
if (is_html_output()) {
visualize(bootstrap_distribution) +
shade_confidence_interval(endpoints = se_ci) #+
...
```{r htdowney, echo=FALSE, fig.cap="Allen Downey's hypothesis testing framework.", out.width=ifelse(knitr::is_latex_output(), "85%", "100%")}
...
```{r hypothesis-testing-create-trial_table, eval=!file.exists("images/gt_error_table_v2.png"), echo=FALSE}
trial_table <- tibble(
...
```{r trial-errors-table, echo=FALSE, fig.cap="Type I and Type II errors in criminal trials.", out.width="95%"}
knitr::include_graphics("images/gt_error_table_v2.png")
```
...
```{r hypothesis-testing-create-hypo_table, eval=!file.exists("images/gt_error_table_ht_v2.png"), echo=FALSE}
hypo_table <- tibble(
...
```{r hypo-test-errors, echo=FALSE, fig.cap="Type I and Type II errors in hypothesis tests.", out.width="95%"}
knitr::include_graphics("images/gt_error_table_ht_v2.png")
```
...
```{r hypothesis-testing-assign-n_movies_sample, echo=FALSE}
# This code is used for dynamic non-static in-line text output purposes
...
```
```{r hypothesis-testing-create-movies_genre_summa, echo=FALSE}
...
```{r hypothesis-testing-null-dist-v10, echo=FALSE}
set.seed(76)
...
```{r hypothesis-testing-v60, echo=FALSE}
...
```{r null-distribution-movies-2, echo=FALSE, fig.cap="Null distribution, observed test statistic, and $p$-value.", fig.height=ifelse(knitr::is_latex_output(), 1.8, 4)}
if (is_html_output()) {
  visualize(null_distribution_movies, bins = 10) +
    shade_p_value(obs_stat = obs_diff_means, direction = "both")
} else {
...
movies_sample |> 
  ...
  summarize(n = n(), mean_rating = mean(rating), std_dev = sd(rating))
```
```{r hypothesis-testing-specify-v5, echo=FALSE}
...
```{r hypothesis-testing-v68, echo=FALSE}
...
```{r hypothesis-testing-conditional-text, echo=FALSE, results="asis"}
if (is_latex_output()) {
...
```{r hypothesis-testing-v72, echo=FALSE, results="asis"}
...
```{r infer-workflow-ht, out.width="100%", echo=FALSE, fig.cap="infer package workflow for hypothesis testing."}
