...
::: {.callout-tip collapse="true" title="Show answer"}
**(c)** Absence of evidence is not evidence of absence. A large $p$-value can also just mean the sample was too small to detect a real difference from $H_0$ — see Q6 for how sample size influences which conclusion the data lets you reach.
:::
