...
In this chapter, we'll start considering a wider array of datasets, all easily accessible via R packages. 

We will also discuss the concept of *correlation* and how it is frequently incorrectly used to imply *causation*. 
...
## One categorical x: Worldwide life expectancy in 2007
