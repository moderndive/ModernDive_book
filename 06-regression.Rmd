...
gapminder2007 <- gapminder %>%
  ...
  mutate(gdpPercap_categ = ifelse(gdpPercap < 15000, "low", "high"))
```
```{r, echo=FALSE}
...
Let's remember these four differences in average life expectancy as compared to Africa: Europe 18.8, Asia 15.9, Europe 22.8, and Oceania 25.9.
