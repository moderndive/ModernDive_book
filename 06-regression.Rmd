...
1. the numerical explanatory/predictor variable $x$: beauty score `bty_avg`
...
1. the numerical outcome variable $y$: instructor evaluation score `score`
1. Two explanatory/predictor variables:
    1. A first numerical explanatory/predictor variable $x_1$: `age`
    1. A second numerical explanatory/predictor variable $x_2$, in this case `gender`


### Exploratory data analysis {#model4EDA}

We've already performed some elements of our exploratory data analysis in Section \@ref(model4EDA), in particular of the outcome variable `score`, so let's now only consider our two new explanatory/predictor variables
