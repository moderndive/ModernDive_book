...
```{r numxplot2-a, warning=FALSE, fig.cap="Comparing regular and jittered scatterplots."}
...
Now let's intepret the terms in the estimate column of the regression table. First $b_0 =$ `intercept = 54.8` corresponds to the mean life expectancy for countries in Africa, since for country $x$ in Africa we have the following equation:
...
However as some of you might have guessed, if someone is sleeping with their shoes on its probably because they are drunk. Furthermore, drinking more tends to cause more hangovers, and hence more headaches. 
