...
Let's visualize the relationship of the outcome variable with each of the two explanatory/predictor variables 
...
In both cases, there seems to be a positive relationship.

However, Figures \@ref(fig:2numxplot1) and \@ref(fig:2numxplot2) only focus on the relationship of the outcome variable with each of the explanatory/predictor variables independently. To get a sense of the *joint* relationship of all three variables simultaneously through a visualization, let's display the data in a 3-dimensional (3D) scatterplot, where
...
used merely to situate the plane in 3D space. 
...
1. 25% of people had credit limits over \$5873. Let's call this group "high" credit limit bracket.
