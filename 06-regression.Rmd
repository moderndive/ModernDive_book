...
* an explanatory/predictor variable $x$, also called an independent variable or \index{variables!explanatory/predictor/independent} \index{covariable!see {{variables!explanatory/predictor/independent}} covariate.
