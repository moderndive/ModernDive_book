...
So all you need to worry about is the what the inputs look like and what the outputs look like; you the details "under the hood of the car." In our regression modeling example, the `get_regression_table()` has
