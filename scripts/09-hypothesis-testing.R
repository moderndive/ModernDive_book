...
## ----tbl-spotify-52-sample, echo=FALSE----------------------------------------
spotify_52_original |> 
  select(-track_id) |> 
  head(10) |> 
...
## ----tbl-spotify-shuffled-52-sample, echo=FALSE-------------------------------
spotify_52_shuffled |> 
  select(-track_id) |> 
  head(10) |> 
...
## ----fig-null-distribution-infer, fig.alt="Histogram of the null distribution of the difference in proportions, generated by 1000 permutations under the null of independence.", fig.show="hold", fig.cap="Null distribution.", fig.height=ifelse(knitr::is_latex_output(), 1.8, 4)----
visualize(null_distribution, bins = 25)


## ----fig-null-distribution-infer-2, fig.alt="Same null distribution histogram with the area beyond the observed test statistic shaded, that shaded area is the p-value.", fig.cap="Shaded histogram to show $p$-value."----
visualize(null_distribution, bins = 25) + 
...
## ----fig-action-romance-boxplot, fig.alt="Side-by-side boxplots of IMDb ratings for Action movies vs Romance movies. Romance has a slightly higher median; spreads are similar.", fig.cap="Boxplot of IMDb rating vs. genre.", fig.height=ifelse(knitr::is_latex_output(), 4, 4)----
...
cat(render_chapter_exercises(9))
...
## ----fig-ha-as-flights-boxplot, fig.alt="Side-by-side boxplots of air time (minutes) for Hawaiian and Alaska Airlines flights leaving NYC in 2023. Hawaiian flights are dramatically longer.", fig.cap="Air time for Hawaiian and Alaska Airlines flights departing NYC in 2023.", fig.height=ifelse(knitr::is_latex_output(), 2.8, 4)----
