...
html <- c(
  ...
  '  section.chapter { margin: 2.5em 0; padding: 1em 1.4em 1.5em; border-radius: 8px; background: #f7f9fc; border-left: 5px solid #5b9bd5; }',
  '  section.chapter > h2 { margin: 0; font-size: 1.35em; }',
