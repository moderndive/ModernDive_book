...
# ---------------------------
# Example:
# extract_learning_checks_min("01-getting-started.Rmd", "scripts/learning-checks/lc/01-learning-checks.md")
# ---------------------------
...
purrr::walk2(chapter_rmds,
             paste0("scripts/learning-checks/lc/", chap_nums, "_learning-checks.md"),
             extract_learning_checks_min)

# For all chapters in V1
v1_chapter_rmds <- list.files(
  path = "scripts/learning-checks/v1",
  pattern = "^(0[1-9]|10|11)-.*\\.Rmd$",
  full.names = TRUE
)

purrr::walk2(v1_chapter_rmds,
             paste0("scripts/learning-checks/v1/", chap_nums, "_v1_learning-checks.md"),
             extract_learning_checks_min)
