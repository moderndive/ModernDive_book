...
v2_lines <- readLines(glue("scripts/learning-checks/lc/{chapter_num}_learning-checks.md"))
v1_lines <- readLines(glue("scripts/learning-checks/v1/{chapter_num}_v1_learning-checks.md"))
...
all_diffs <- map_dfr(chapter_nums, function(chap) {
  v2_lines <- readLines(glue("scripts/learning-checks/lc/{chap}_learning-checks.md"))
  v1_lines <- readLines(glue("scripts/learning-checks/v1/{chap}_v1_learning-checks.md"))
