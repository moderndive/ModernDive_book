...
```{r promotions-barplot, echo=FALSE, fig.cap="Barplot of relationship between gender and promotion decision."}
...
```{r null-distribution-infer, fig.show='hold', fig.cap="Null distribution", purl=FALSE}
...
```{r null-distribution-movies-2, echo=FALSE, fig.cap="Null distribution, observed test statistic, and p-value."}
if(knitr::is_html_output()){
  visualize(null_distribution_movies, bins = 10) + 
    shade_p_value(obs_stat = obs_diff_means, direction = "both")
} else {
