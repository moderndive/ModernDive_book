...
knitr::include_graphics("images/there_is_only_one_test.png")
```
...
```{r zcurve, echo=FALSE, out.width="80%", fig.cap="Standard normal z curve."}
...
```{r t-distributions, echo=FALSE, fig.cap="Examples of t-distributions and the z curve.", purl=FALSE}
...
tibble(
  ...
  mutate(
    type = ifelse(Distribution == "z-curve", "t", "z"),
    Distribution = factor(Distribution, levels = c("z", "t: df = 10", "t: df = 3", "t: df = 1"))
    ) %>% 
