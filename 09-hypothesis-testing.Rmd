...
```{r code-1, echo=FALSE, purl=FALSE}
...
```{r code-2, echo=FALSE, purl=FALSE}
alpha <- 0.1
```
...
```
```{r mutate, echo=FALSE, purl=FALSE}
...
```
```{r summarize-4, echo=FALSE, purl=FALSE}
...
movies_sample |> 
  ...
  summarize(n = n(), mean_rating = mean(rating), std_dev = sd(rating))
```
```{r specify-7, echo=FALSE, purl=FALSE}
