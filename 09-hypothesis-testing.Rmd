...
```{r hypothesis-testing-1, message=FALSE}
library(tidyverse)
library(moderndive)
library(infer)
...
```{r hypothesis-testing-2, message=FALSE, echo=FALSE, purl=FALSE}
...
```{r hypothesis-testing-5, eval=FALSE}
almonds_sample_100 |>
...
```{r hypothesis-testing-6, eval = FALSE}
2 * pt(q = -2.26, df = 100 - 1)
```

```{r hypothesis-testing-7, echo = FALSE, purl=FALSE}
...
```{r hypothesis-testing-9, echo=TRUE}
...
```{r hypothesis-testing-10, echo=FALSE}
p_val_almonds <- null_dist |>
  get_p_value(obs_stat = x_bar_almonds, direction = "two-sided") 
```

```{r hypothesis-testing-11, eval=FALSE, echo=FALSE, purl=FALSE}
p_val_almonds |> 
  kbl(
    digits = 3,
    caption = "The p value",
...
```{r hypothesis-testing-13, eval=FALSE}
...
```{r hypothesis-testing-14, echo=FALSE, purl=FALSE}
bootstrap_means <- read_rds("rds/bootstrap_means_almonds.rds")
```


```{r hypothesis-testing-15}
bootstrap_means |> 
...
```{r hypothesis-testing-16, echo=FALSE, purl=FALSE}
...
```{r hypothesis-testing-17, echo=FALSE}
set.seed(2)
```

```{r hypothesis-testing-18, eval=FALSE}
...
```{r hypothesis-testing-19, eval=FALSE}
...
```{r hypothesis-testing-20}
spotify_metal_deephouse |> 
  group_by(track_genre, popular_or_not) |>
  tally() # Same as summarize(n = n())
```

```{r hypothesis-testing-21, echo=FALSE, purl=FALSE}
...
```{r hypothesis-testing-22, echo=FALSE, purl=FALSE}
# This code is used for dynamic non-static in-line text output purposes
...
```{r hypothesis-testing-23, eval=FALSE}
spotify_52_original |> 
  select(-track_id) |> 
  head(10)
```
...
```{r hypothesis-testing-24, eval=FALSE}
spotify_52_shuffled |> 
  select(-track_id) |> 
  head(10)
```
...
```{r hypothesis-testing-25, eval=FALSE}
...
```{r hypothesis-testing-26}
spotify_52_shuffled |> 
  group_by(track_genre, popular_or_not) |> 
  tally()
```
```{r hypothesis-testing-27, echo=FALSE, purl=FALSE}
# metal stats
...
```{r hypothesis-testing-28, echo=FALSE, purl=FALSE}
alpha <- 0.1
```
...
```{r hypothesis-testing-31, echo=FALSE, purl=FALSE}
# This code is used for dynamic non-static in-line text output purposes
n_reps <- 1000L
```
...
```{r hypothesis-testing-32, eval=FALSE}
...
```{r hypothesis-testing-33, echo=FALSE, purl=FALSE}
...
```{r hypothesis-testing-34, eval=FALSE}
...
```{r hypothesis-testing-35, echo=FALSE, purl=FALSE}
...
```{r hypothesis-testing-38}
null_distribution |> 
  get_p_value(obs_stat = obs_diff_prop, direction = "right")
```
```{r hypothesis-testing-39, echo=FALSE, purl=FALSE}
...
```{r hypothesis-testing-40, eval=FALSE}
null_distribution <- spotify_metal_deephouse |> 
  specify(formula = popular_or_not ~ track_genre, success = "popular") |> 
  hypothesize(null = "independence") |> 
  generate(reps = 1000, type = "permute") |> 
...
```{r hypothesis-testing-41, eval=FALSE}
...
```{r hypothesis-testing-42, echo=FALSE, purl=FALSE}
...
```{r hypothesis-testing-44, eval=FALSE}
...
```{r hypothesis-testing-45, eval=FALSE}
...
```{r hypothesis-testing-46, eval=FALSE}
visualize(bootstrap_distribution) + 
...
```{r hypothesis-testing-47, eval=FALSE}
library(moderndive)
library(infer)
...
```{r hypothesis-testing-48, eval=!file.exists("images/gt_error_table_v2.png"), echo=FALSE, purl=FALSE}
trial_table <- tibble(
...
```{r hypothesis-testing-49, eval=!file.exists("images/gt_error_table_ht_v2.png"), echo=FALSE, purl=FALSE}
hypo_table <- tibble(
...
```{r hypothesis-testing-50}
movies
```

```{r hypothesis-testing-51, echo=FALSE, purl=FALSE}
# This code is used for dynamic non-static in-line text output purposes
...
```{r hypothesis-testing-53}
movies_sample |> 
  group_by(genre) |> 
  summarize(n = n(), mean_rating = mean(rating), std_dev = sd(rating))
```
```{r hypothesis-testing-54, echo=FALSE, purl=FALSE}
...
```{r hypothesis-testing-57, eval=FALSE}
movies_sample |> 
  specify(formula = rating ~ genre) |> 
  hypothesize(null = "independence") |> 
  generate(reps = 1000, type = "permute") |> 
...
```{r hypothesis-testing-58, echo=FALSE, purl=FALSE}
set.seed(76)
...
```{r hypothesis-testing-59, eval=FALSE}
...
```{r hypothesis-testing-60, echo=FALSE, purl=FALSE}
...
```{r hypothesis-testing-62, eval=FALSE}
...
```{r hypothesis-testing-63}
null_distribution_movies |> 
  get_p_value(obs_stat = obs_diff_means, direction = "both")
```
```{r hypothesis-testing-64, echo=FALSE}
...
```{r hypothesis-testing-65}
movies_sample |> 
  group_by(genre) |> 
  summarize(n = n(), mean_rating = mean(rating), std_dev = sd(rating))
```
```{r hypothesis-testing-66, echo=FALSE, purl=FALSE}
...
```{r hypothesis-testing-68, echo=FALSE, purl=FALSE}
...
```{r hypothesis-testing-71, echo=FALSE, results="asis", purl=FALSE}
if (is_latex_output()) {
...
```{r hypothesis-testing-72, echo=FALSE, purl=FALSE, results="asis"}
