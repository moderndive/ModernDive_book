...
To begin the analysis, `r n_songs` were selected at random from Spotify's song archive. There were `r songs_by_genre` metal songs and `r songs_by_genre` deep house songs selected. 
