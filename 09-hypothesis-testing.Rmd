...
```{r htdowney, echo=FALSE, fig.cap="Allen Downey's hypothesis testing framework.", purl=FALSE, out.width=ifelse(knitr::is_latex_output(), "110%", "100%")}
...
```{r trial-errors-table, echo=FALSE, fig.cap="Type I and Type II errors in criminal trials.", purl=FALSE, out.width=if(!knitr::is_latex_output()) "100%"}
...
```{r hypo-test-errors, echo=FALSE, fig.cap="Type I and Type II errors in hypothesis tests.", purl=FALSE, out.width=if(!knitr::is_latex_output()) "100%"}
