...
```{r t-curve-hypo, echo=FALSE, fig.height=ifelse(is_latex_output(), 2, 4), fig.width=3, purl=FALSE, fig.cap="The tails of a t curve for this hypothesis test."}
...
```
```{r bootstrap-distribution-two-prop-percentile, echo=FALSE, fig.show="hold", fig.cap="Percentile-based 95\\% confidence interval.", purl=FALSE, fig.height=ifelse(knitr::is_latex_output(), 3.2, 4)}
if (is_html_output()) {
  visualize(bootstrap_distribution) +
    shade_confidence_interval(endpoints = percentile_ci)
} else {
