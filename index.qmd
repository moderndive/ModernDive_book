---
# Quarto book - main config in _quarto.yml
---
...
opts_chunk$set(
  ...
  fig.pos = 'H',
  fig.retina = 1,
#  fig.width = if(knitr::knitr::is_html_output()) "6",
  fig.asp = if(knitr::knitr::is_html_output()) 2/3
)
```
...
if (knitr::knitr::is_html_output()) {
  cat("# Welcome to ModernDive (v2) {.unnumbered}")
}
```
...
```{r, echo=FALSE, include=!knitr::knitr::is_latex_output(), purl=FALSE}
dev_version <- FALSE
```
...
<!-- index.qmd has to have some content in it or it won't create an index.html 
