...
```{r appendixD-1, child = "lc-answers/01_lc-answers.Rmd"}
```
...
```{r appendixD-alt, child = "lc-answers/02_lc-answers.Rmd"}
```
...
```{r appendixD-alt2, child = "lc-answers/03_lc-answers.Rmd"}
```
...
```{r appendixD-v4, child = "lc-answers/04_lc-answers.Rmd"}
```
...
```{r appendixD-v5, child = "lc-answers/05_lc-answers.Rmd"}
```
...
```{r appendixD-v6, child = "lc-answers/06_lc-answers.Rmd"}
```
...
```{r appendixD-v7, child = "lc-answers/07_lc-answers.Rmd"}
```
...
```{r appendixD-v8, child = "lc-answers/08_lc-answers.Rmd"}
```
...
```{r appendixD-v9, child = "lc-answers/09_lc-answers.Rmd"}
```
...
```{r appendixD-v10, child = "lc-answers/10_lc-answers.Rmd"}
```
...
```{r appendixD-v11, child = "lc-answers/11_lc-answers.Rmd"}
```
...
```{r appendixD-v12, child = "lc-answers/A1_lc-answers.Rmd"}
```
