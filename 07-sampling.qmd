...
a. The values in the population
b. How the statistic varies across many possible samples of the same size
c. The values in a single sample
...
a. The sampling distribution of the mean is approximately normal for large enough $n$, regardless of the population distribution's shape
b. Larger samples have smaller means
...
c. **A number computed from a sample (varies sample to sample)**
...
d. **The sample proportion (an estimate of $p$)**
...
d. **The distribution of one sample — not a sampling distribution**
...
a. 52% always means the candidate is winning
b. **Nothing — sample proportions naturally vary around $p$**
