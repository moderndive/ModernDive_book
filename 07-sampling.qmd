...
```{r sampling-demo-code, echo=FALSE, fig.cap="Inserting a shovel into the bowl.", purl=FALSE, out.width="100%", purl=FALSE}
include_graphics("images/sampling/balls/sampling_bowl_2.jpg")
```


```{r sampling-demo-code-v2, echo=FALSE, fig.cap="Taking a sample of 50 balls from the bowl.", purl=FALSE, out.width="80%", purl=FALSE}
...
```{r sampling-exercise-v4, echo=FALSE, fig.cap="Students drawing a histogram of sample proportions.", purl=FALSE, out.width="60%"}
...
```{r sampling-exercise-v5, echo=FALSE, fig.cap="Hand-drawn histogram of 10 sample proportions.", purl=FALSE, out.height="30%"}
...
```
```{r sampling-hist-white-border-v2-dup1, echo=FALSE, fig.cap="The distribution of 1000 proportions based on 1000 random samples of size 50.", fig.height=ifelse(knitr::is_latex_output(), 2.3, 4), purl=FALSE}
virtual_histogram <- ggplot(virtual_prop_red, aes(x = prop_red)) +
  geom_histogram(binwidth = 0.04, boundary = 0.4, color = "white")
virtual_histogram +
  labs(
...
```{r sampling-facet-viz, echo=FALSE, fig.cap="Three sampling distributions with population proportion $p$ marked by vertical line.", purl=FALSE, fig.height=ifelse(knitr::is_latex_output(), 3, 4)}
p <- bowl |>
...
```{r sampling-hist-white-border-v2-dup4, echo=FALSE, fig.cap="The distribution of 1000 means based on 1000 random samples of size 25.", purl=FALSE, fig.height=ifelse(knitr::is_latex_output(), 1.5, 4)}
virtual_mean_weight <- virtual_samples_almonds |> 
  summarize(mean_weight = mean(weight))
...
```{r comparing-sampling-distributions-means, echo=FALSE, fig.height=ifelse(knitr::is_latex_output(), 3, 4), fig.cap="Comparing histograms of sample means when using different sample sizes.", purl=FALSE}
# n = 25
...
```{r sample-mean-25-with-normal, echo=FALSE, fig.height=ifelse(knitr::is_latex_output(), 3.1, 4), fig.cap="The distribution of the sample mean (n=25).", purl=FALSE}
n = 25
...
```{r sample-mean-100-with-normal, echo=FALSE, fig.height=ifelse(knitr::is_latex_output(), 3.1, 4), fig.cap="The distribution of the sample mean (n=100).", purl=FALSE}
n = 100
x = almonds_bowl$weight
mu = mean(x)
sigma = sqrt(mean(x^2)-mean(x)^2)
...
```
```{r sampling-hist-white-border-v2-dup7, echo=FALSE, fig.cap="The distribution of 1000 differences in sample proportions based on 1000 random samples of size 50 from the first bowl and 1000 random samples of size 60 from the second bowl.", purl=FALSE, fig.height=ifelse(knitr::is_latex_output(), 5.5, 7),}
