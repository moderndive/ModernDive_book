...
library(infer)
library(readr)
# volcanoes + exoplanets are GitHub-only; read their datasets from the v2 raw mirror.
# Exercises in this chapter reference `planets`, `eruptions`, and `volcanoes` datasets.
planets <- read_csv(
  "https://raw.githubusercontent.com/moderndive/ModernDive_book/v2/data/exoplanets_planets.csv.gz",
  show_col_types = FALSE
)
eruptions <- read_csv(
  "https://raw.githubusercontent.com/moderndive/ModernDive_book/v2/data/volcanoes_eruptions.csv.gz",
  show_col_types = FALSE
)
volcanoes <- read_csv(
  "https://raw.githubusercontent.com/moderndive/ModernDive_book/v2/data/volcanoes_volcanoes.csv.gz",
  show_col_types = FALSE
)
```
