...
(a) population mean of elevations
(b) sample mean of elevations from a fresh draw of $n=30$ volcanoes
(c) population proportion of stratovolcanoes
(d) sample proportion of stratovolcanoes from a fresh draw
...
### Sampling distribution for two samples {.unnumbered}
...
**EX7.31 (★★★)** Sample 30 volcanoes **without replacement** (the `rep_sample_n()` default) vs **with replacement**. For a population of ~1,200 and $n = 30$, do the sampling distributions differ much? Why?
