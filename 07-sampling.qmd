...
::: {.callout-tip collapse="true" title="Show answer"}
**(b)** The expected value of the sample mean is the population mean. So the *center* of the sampling distribution = the parameter being estimated: the histogram of the 1000 sample means piles up around $\mu$.
:::
...
::: {.callout-tip collapse="true" title="Show answer"}
**(b)** The "hat" in $\widehat{p}$ signals an estimate computed from a sample. Parameters like $p$, $\mu$, and $\sigma$ describe the population; their sample-based estimates wear hats.
:::
