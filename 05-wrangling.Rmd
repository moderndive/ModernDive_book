...
In this chapter we'll display the contents of certain data frames using the `kable()` function from the `knitr` package in Subsection \@ref(exploredataframes); all it does is yield an alternative formating of all data frames. 
