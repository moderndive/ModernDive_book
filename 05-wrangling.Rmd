...
```{asis lc-groupby-solutions, include=show_solutions('5-3')}
**Learning Check Solutions**  
...
```{r, echo=FALSE, include=show_solutions('5-3')}
kable(summary_temp_by_month)
```

```{asis, include=show_solutions('5-3')}
...
```{r, echo=show_solutions('5-3'), include=show_solutions('5-3')}
...
```{r, eval=FALSE, echo=show_solutions('5-3')}
by_monthly_origin
```
...
```{r, eval=FALSE, include=show_solutions('5-3')}
...
```{asis lc-mutate-solutions, include=show_solutions('5-4')}
**Learning Check Solutions**  
...
* Then `gain = arr_delay - dep_delay = 20 - 10  = 10` is negative, so it "made
up time in the air".
...
```{asis lc-join-solutions, include=show_solutions('5-5')}
**Learning Check Solutions**
...
```{asis, include=show_solutions('5-6')}
**Learning Check Solutions**  
...
```{r, echo=show_solutions('5-6'), include=show_solutions('5-6')}
library(dplyr)
library(nycflights13)
```
...
An R script file of all R code used in this chapter is available [here](http://moderndive.com/scripts/05-wrangling.R).
