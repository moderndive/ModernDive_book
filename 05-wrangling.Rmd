...
# solutions_shown <- c('5-1', '5-2', '5-3', '5-4', '5-5', '5-6')
solutions_shown <- c('')
...
An R script file of all R code used in this chapter is available [here](https://ismayc.github.io/moderndiver-book/scripts/05-wrangling.R).
